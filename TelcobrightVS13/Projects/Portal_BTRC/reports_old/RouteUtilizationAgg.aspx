<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="True"
    CodeBehind="RouteUtilizationAgg.aspx.cs" Inherits="DefaultRtUtilAgg" %>
...
<%--Page Load and Other Server Side Asp.net scripts--%>
        <script runat="server">
            ...
            if(lblScreenTitle.Text=="")
                    {
                        lblScreenTitle.Text = "Reports/Route Utilization/Aggregate";
                    }
...
<div>
 ...
 <div id="ParamBorder" style="float:left;padding-top:3px;padding-left:10px;height:135px;display:block;border:2px ridge #E5E4E2;margin-bottom:5px;width:1100px;">
    <div style="height:20px;background-color:#f2f2f2;color:black;"> 
        <span style="float:left;visibility:hidden;font-weight:bold;padding-left:20px;">   Show Egress Erlang <asp:CheckBox ID="CheckBoxShowPerformance" runat="server" /></span> 
...
<div style="float:left;text-align:left;width:900px;position:relative;top:0px;padding-left:5px;">
    ...
    <div style="width:760px;text-align:center;">
        ...
        <Columns>
            ...
            <asp:BoundField DataField="RouteName" HeaderText="Route" SortExpression="RouteName" />
            <asp:BoundField DataField="TotalPorts" HeaderText="Total Ports" SortExpression="Ports" />
