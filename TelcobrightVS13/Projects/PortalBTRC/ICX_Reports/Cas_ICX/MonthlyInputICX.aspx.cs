...
namespace PortalApp.ICX_Reports.Cas_ICX
{
    public partial class MonthlyInputICX : System.Web.UI.Page
    {
        ...
        string getSqlQuery(int year, int month)
        {
            ...
            string localdb = $@"select 'Gazi Networks Limited' as callDateCalc, domestic DomesticDurationCalc, intIn IntlOutDurationCalc, intOut IntlInDurationCalc  from(select yearMonth, domestic, intIn from(select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth, sum(duration1)/60 domestic from  gazinetworks_cas.sum_voice_day_01 where tup_starttime >= '{date1}' and tup_starttime < '{date2}'  group by concat(year(tup_starttime),'-' ,month(tup_starttime))) dom left join (select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth1, sum(duration1)/60 IntIn from   gazinetworks_cas.sum_voice_day_03 where tup_starttime >= '{date1}' and tup_starttime < '{date2}' group by concat(year(tup_starttime),'-' ,month(tup_starttime))) intIn  on dom.yearMonth = intIn.yearMonth1 )domIntOut left join (select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth2, sum(duration1)/60 IntOut from   gazinetworks_cas.sum_voice_day_02 where tup_starttime >= '{date1}' and tup_starttime < '{date2}' group by concat(year(tup_starttime),'-' ,month(tup_starttime))) intOut on domIntOut.yearMonth = intOut.yearMonth2";
            string livedb = $@"
select 'Agni ICX' as callDateCalc, domestic DomesticDurationCalc, intIn IntlOutDurationCalc, intOut IntlInDurationCalc  from(select yearMonth, domestic, intIn from(select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth, sum(duration1)/60 domestic from  agni_cas.sum_voice_day_01 where tup_starttime >= '{date1}' and tup_starttime < '{date2}'  group by concat(year(tup_starttime),'-' ,month(tup_starttime))) dom left join (select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth1, sum(duration1)/60 IntIn from   agni_cas.sum_voice_day_03 where tup_starttime >= '{date1}' and tup_starttime < '{date2}' group by concat(year(tup_starttime),'-' ,month(tup_starttime))) intIn  on dom.yearMonth = intIn.yearMonth1 )domIntOut left join (select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth2, sum(duration1)/60 IntOut from   agni_cas.sum_voice_day_02 where tup_starttime >= '{date1}' and tup_starttime < '{date2}' group by concat(year(tup_starttime),'-' ,month(tup_starttime))) intOut on domIntOut.yearMonth = intOut.yearMonth2 union all
select 'BTCL' as callDateCalc, domestic DomesticDurationCalc, intIn IntlOutDurationCalc, intOut IntlInDurationCalc  from(select yearMonth, domestic, intIn from(select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth, sum(duration1)/60 domestic from  btcl_cas.sum_voice_day_01 where tup_starttime >= '{date1}' and tup_starttime < '{date2}'  group by concat(year(tup_starttime),'-' ,month(tup_starttime))) dom left join (select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth1, sum(duration1)/60 IntIn from   btcl_cas.sum_voice_day_03 where tup_starttime >= '{date1}' and tup_starttime < '{date2}' group by concat(year(tup_starttime),'-' ,month(tup_starttime))) intIn  on dom.yearMonth = intIn.yearMonth1 )domIntOut left join (select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth2, sum(duration1)/60 IntOut from   btcl_cas.sum_voice_day_02 where tup_starttime >= '{date1}' and tup_starttime < '{date2}' group by concat(year(tup_starttime),'-' ,month(tup_starttime))) intOut on domIntOut.yearMonth = intOut.yearMonth2 union all
select 'Bangla ICX' as callDateCalc, domestic DomesticDurationCalc, intIn IntlOutDurationCalc, intOut IntlInDurationCalc  from(select yearMonth, domestic, intIn from(select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth, sum(duration1)/60 domestic from  banglatelecom_cas.sum_voice_day_01 where tup_starttime >= '{date1}' and tup_starttime < '{date2}'  group by concat(year(tup_starttime),'-' ,month(tup_starttime))) dom left join (select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth1, sum(duration1)/60 IntIn from   banglatelecom_cas.sum_voice_day_03 where tup_starttime >= '{date1}' and tup_starttime < '{date2}' group by concat(year(tup_starttime),'-' ,month(tup_starttime))) intIn  on dom.yearMonth = intIn.yearMonth1 )domIntOut left join (select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth2, sum(duration1)/60 IntOut from   banglatelecom_cas.sum_voice_day_02 where tup_starttime >= '{date1}' and tup_starttime < '{date2}' group by concat(year(tup_starttime),'-' ,month(tup_starttime))) intOut on domIntOut.yearMonth = intOut.yearMonth2 union all
select 'Bangla Telecom Ltd' as callDateCalc, domestic DomesticDurationCalc, intIn IntlOutDurationCalc, intOut IntlInDurationCalc  from(select yearMonth, domestic, intIn from(select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth, sum(duration1)/60 domestic from  banglaicx_cas.sum_voice_day_01 where tup_starttime >= '{date1}' and tup_starttime < '{date2}'  group by concat(year(tup_starttime),'-' ,month(tup_starttime))) dom left join (select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth1, sum(duration1)/60 IntIn from   banglaicx_cas.sum_voice_day_03 where tup_starttime >= '{date1}' and tup_starttime < '{date2}' group by concat(year(tup_starttime),'-' ,month(tup_starttime))) intIn  on dom.yearMonth = intIn.yearMonth1 )domIntOut left join (select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth2, sum(duration1)/60 IntOut from   banglaicx_cas.sum_voice_day_02 where tup_starttime >= '{date1}' and tup_starttime < '{date2}' group by concat(year(tup_starttime),'-' ,month(tup_starttime))) intOut on domIntOut.yearMonth = intOut.yearMonth2 union all
select 'Bantel Limited' as callDateCalc, domestic DomesticDurationCalc, intIn IntlOutDurationCalc, intOut IntlInDurationCalc  from(select yearMonth, domestic, intIn from(select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth, sum(duration1)/60 domestic from  bantel_cas.sum_voice_day_01 where tup_starttime >= '{date1}' and tup_starttime < '{date2}'  group by concat(year(tup_starttime),'-' ,month(tup_starttime))) dom left join (select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth1, sum(duration1)/60 IntIn from   bantel_cas.sum_voice_day_03 where tup_starttime >= '{date1}' and tup_starttime < '{date2}' group by concat(year(tup_starttime),'-' ,month(tup_starttime))) intIn  on dom.yearMonth = intIn.yearMonth1 )domIntOut left join (select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth2, sum(duration1)/60 IntOut from   bantel_cas.sum_voice_day_02 where tup_starttime >= '{date1}' and tup_starttime < '{date2}' group by concat(year(tup_starttime),'-' ,month(tup_starttime))) intOut on domIntOut.yearMonth = intOut.yearMonth2 union all
select 'Cross World Telecom Limited' as callDateCalc, domestic DomesticDurationCalc, intIn IntlOutDurationCalc, intOut IntlInDurationCalc  from(select yearMonth, domestic, intIn from(select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth, sum(duration1)/60 domestic from  crossworld_cas.sum_voice_day_01 where tup_starttime >= '{date1}' and tup_starttime < '{date2}'  group by concat(year(tup_starttime),'-' ,month(tup_starttime))) dom left join (select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth1, sum(duration1)/60 IntIn from   crossworld_cas.sum_voice_day_03 where tup_starttime >= '{date1}' and tup_starttime < '{date2}' group by concat(year(tup_starttime),'-' ,month(tup_starttime))) intIn  on dom.yearMonth = intIn.yearMonth1 )domIntOut left join (select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth2, sum(duration1)/60 IntOut from   crossworld_cas.sum_voice_day_02 where tup_starttime >= '{date1}' and tup_starttime < '{date2}' group by concat(year(tup_starttime),'-' ,month(tup_starttime))) intOut on domIntOut.yearMonth = intOut.yearMonth2 union all
select 'Gazi Networks Limited' as callDateCalc, domestic DomesticDurationCalc, intIn IntlOutDurationCalc, intOut IntlInDurationCalc  from(select yearMonth, domestic, intIn from(select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth, sum(duration1)/60 domestic from  gazinetworks_cas.sum_voice_day_01 where tup_starttime >= '{date1}' and tup_starttime < '{date2}'  group by concat(year(tup_starttime),'-' ,month(tup_starttime))) dom left join (select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth1, sum(duration1)/60 IntIn from   gazinetworks_cas.sum_voice_day_03 where tup_starttime >= '{date1}' and tup_starttime < '{date2}' group by concat(year(tup_starttime),'-' ,month(tup_starttime))) intIn  on dom.yearMonth = intIn.yearMonth1 )domIntOut left join (select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth2, sum(duration1)/60 IntOut from   gazinetworks_cas.sum_voice_day_02 where tup_starttime >= '{date1}' and tup_starttime < '{date2}' group by concat(year(tup_starttime),'-' ,month(tup_starttime))) intOut on domIntOut.yearMonth = intOut.yearMonth2 union all
select 'Imam Network Ltd' as callDateCalc, domestic DomesticDurationCalc, intIn IntlOutDurationCalc, intOut IntlInDurationCalc  from(select yearMonth, domestic, intIn from(select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth, sum(duration1)/60 domestic from  imamnetwork_cas.sum_voice_day_01 where tup_starttime >= '{date1}' and tup_starttime < '{date2}'  group by concat(year(tup_starttime),'-' ,month(tup_starttime))) dom left join (select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth1, sum(duration1)/60 IntIn from   imamnetwork_cas.sum_voice_day_03 where tup_starttime >= '{date1}' and tup_starttime < '{date2}' group by concat(year(tup_starttime),'-' ,month(tup_starttime))) intIn  on dom.yearMonth = intIn.yearMonth1 )domIntOut left join (select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth2, sum(duration1)/60 IntOut from   imamnetwork_cas.sum_voice_day_02 where tup_starttime >= '{date1}' and tup_starttime < '{date2}' group by concat(year(tup_starttime),'-' ,month(tup_starttime))) intOut on domIntOut.yearMonth = intOut.yearMonth2 union all
select 'Integrated Services Limited (Sheba ICX)' as callDateCalc, domestic DomesticDurationCalc, intIn IntlOutDurationCalc, intOut IntlInDurationCalc  from(select yearMonth, domestic, intIn from(select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth, sum(duration1)/60 domestic from  sheba_cas.sum_voice_day_01 where tup_starttime >= '{date1}' and tup_starttime < '{date2}'  group by concat(year(tup_starttime),'-' ,month(tup_starttime))) dom left join (select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth1, sum(duration1)/60 IntIn from   sheba_cas.sum_voice_day_03 where tup_starttime >= '{date1}' and tup_starttime < '{date2}' group by concat(year(tup_starttime),'-' ,month(tup_starttime))) intIn  on dom.yearMonth = intIn.yearMonth1 )domIntOut left join (select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth2, sum(duration1)/60 IntOut from   sheba_cas.sum_voice_day_02 where tup_starttime >= '{date1}' and tup_starttime < '{date2}' group by concat(year(tup_starttime),'-' ,month(tup_starttime))) intOut on domIntOut.yearMonth = intOut.yearMonth2 union all
select 'JibonDhara Solutions Limited' as callDateCalc, domestic DomesticDurationCalc, intIn IntlOutDurationCalc, intOut IntlInDurationCalc  from(select yearMonth, domestic, intIn from(select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth, sum(duration1)/60 domestic from  jibondhara_cas.sum_voice_day_01 where tup_starttime >= '{date1}' and tup_starttime < '{date2}'  group by concat(year(tup_starttime),'-' ,month(tup_starttime))) dom left join (select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth1, sum(duration1)/60 IntIn from   jibondhara_cas.sum_voice_day_03 where tup_starttime >= '{date1}' and tup_starttime < '{date2}' group by concat(year(tup_starttime),'-' ,month(tup_starttime))) intIn  on dom.yearMonth = intIn.yearMonth1 )domIntOut left join (select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth2, sum(duration1)/60 IntOut from   jibondhara_cas.sum_voice_day_02 where tup_starttime >= '{date1}' and tup_starttime < '{date2}' group by concat(year(tup_starttime),'-' ,month(tup_starttime))) intOut on domIntOut.yearMonth = intOut.yearMonth2 union all
select 'M&H Telecom Limited' as callDateCalc, domestic DomesticDurationCalc, intIn IntlOutDurationCalc, intOut IntlInDurationCalc  from(select yearMonth, domestic, intIn from(select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth, sum(duration1)/60 domestic from  mnh_cas.sum_voice_day_01 where tup_starttime >= '{date1}' and tup_starttime < '{date2}'  group by concat(year(tup_starttime),'-' ,month(tup_starttime))) dom left join (select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth1, sum(duration1)/60 IntIn from   mnh_cas.sum_voice_day_03 where tup_starttime >= '{date1}' and tup_starttime < '{date2}' group by concat(year(tup_starttime),'-' ,month(tup_starttime))) intIn  on dom.yearMonth = intIn.yearMonth1 )domIntOut left join (select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth2, sum(duration1)/60 IntOut from   mnh_cas.sum_voice_day_02 where tup_starttime >= '{date1}' and tup_starttime < '{date2}' group by concat(year(tup_starttime),'-' ,month(tup_starttime))) intOut on domIntOut.yearMonth = intOut.yearMonth2 union all
select 'Mother Telecommunication' as callDateCalc, domestic DomesticDurationCalc, intIn IntlOutDurationCalc, intOut IntlInDurationCalc  from(select yearMonth, domestic, intIn from(select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth, sum(duration1)/60 domestic from  mothertelecom_cas.sum_voice_day_01 where tup_starttime >= '{date1}' and tup_starttime < '{date2}'  group by concat(year(tup_starttime),'-' ,month(tup_starttime))) dom left join (select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth1, sum(duration1)/60 IntIn from   mothertelecom_cas.sum_voice_day_03 where tup_starttime >= '{date1}' and tup_starttime < '{date2}' group by concat(year(tup_starttime),'-' ,month(tup_starttime))) intIn  on dom.yearMonth = intIn.yearMonth1 )domIntOut left join (select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth2, sum(duration1)/60 IntOut from   mothertelecom_cas.sum_voice_day_02 where tup_starttime >= '{date1}' and tup_starttime < '{date2}' group by concat(year(tup_starttime),'-' ,month(tup_starttime))) intOut on domIntOut.yearMonth = intOut.yearMonth2 union all
select 'New Generation Telecom Limited' as callDateCalc, domestic DomesticDurationCalc, intIn IntlOutDurationCalc, intOut IntlInDurationCalc  from(select yearMonth, domestic, intIn from(select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth, sum(duration1)/60 domestic from  newgenerationtelecom_cas.sum_voice_day_01 where tup_starttime >= '{date1}' and tup_starttime < '{date2}'  group by concat(year(tup_starttime),'-' ,month(tup_starttime))) dom left join (select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth1, sum(duration1)/60 IntIn from   newgenerationtelecom_cas.sum_voice_day_03 where tup_starttime >= '{date1}' and tup_starttime < '{date2}' group by concat(year(tup_starttime),'-' ,month(tup_starttime))) intIn  on dom.yearMonth = intIn.yearMonth1 )domIntOut left join (select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth2, sum(duration1)/60 IntOut from   newgenerationtelecom_cas.sum_voice_day_02 where tup_starttime >= '{date1}' and tup_starttime < '{date2}' group by concat(year(tup_starttime),'-' ,month(tup_starttime))) intOut on domIntOut.yearMonth = intOut.yearMonth2 union all
select 'Paradise Telecom Limited' as callDateCalc, domestic DomesticDurationCalc, intIn IntlOutDurationCalc, intOut IntlInDurationCalc  from(select yearMonth, domestic, intIn from(select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth, sum(duration1)/60 domestic from  paradise_cas.sum_voice_day_01 where tup_starttime >= '{date1}' and tup_starttime < '{date2}'  group by concat(year(tup_starttime),'-' ,month(tup_starttime))) dom left join (select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth1, sum(duration1)/60 IntIn from   paradise_cas.sum_voice_day_03 where tup_starttime >= '{date1}' and tup_starttime < '{date2}' group by concat(year(tup_starttime),'-' ,month(tup_starttime))) intIn  on dom.yearMonth = intIn.yearMonth1 )domIntOut left join (select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth2, sum(duration1)/60 IntOut from   paradise_cas.sum_voice_day_02 where tup_starttime >= '{date1}' and tup_starttime < '{date2}' group by concat(year(tup_starttime),'-' ,month(tup_starttime))) intOut on domIntOut.yearMonth = intOut.yearMonth2 union all
select 'Purple Telecom Limited' as callDateCalc, domestic DomesticDurationCalc, intIn IntlOutDurationCalc, intOut IntlInDurationCalc  from(select yearMonth, domestic, intIn from(select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth, sum(duration1)/60 domestic from  purple_cas.sum_voice_day_01 where tup_starttime >= '{date1}' and tup_starttime < '{date2}'  group by concat(year(tup_starttime),'-' ,month(tup_starttime))) dom left join (select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth1, sum(duration1)/60 IntIn from   purple_cas.sum_voice_day_03 where tup_starttime >= '{date1}' and tup_starttime < '{date2}' group by concat(year(tup_starttime),'-' ,month(tup_starttime))) intIn  on dom.yearMonth = intIn.yearMonth1 )domIntOut left join (select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth2, sum(duration1)/60 IntOut from   purple_cas.sum_voice_day_02 where tup_starttime >= '{date1}' and tup_starttime < '{date2}' group by concat(year(tup_starttime),'-' ,month(tup_starttime))) intOut on domIntOut.yearMonth = intOut.yearMonth2 union all
select 'RingTech(Bangladesh) Limited' as callDateCalc, domestic DomesticDurationCalc, intIn IntlOutDurationCalc, intOut IntlInDurationCalc  from(select yearMonth, domestic, intIn from(select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth, sum(duration1)/60 domestic from  ringtech_cas.sum_voice_day_01 where tup_starttime >= '{date1}' and tup_starttime < '{date2}'  group by concat(year(tup_starttime),'-' ,month(tup_starttime))) dom left join (select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth1, sum(duration1)/60 IntIn from   ringtech_cas.sum_voice_day_03 where tup_starttime >= '{date1}' and tup_starttime < '{date2}' group by concat(year(tup_starttime),'-' ,month(tup_starttime))) intIn  on dom.yearMonth = intIn.yearMonth1 )domIntOut left join (select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth2, sum(duration1)/60 IntOut from   ringtech_cas.sum_voice_day_02 where tup_starttime >= '{date1}' and tup_starttime < '{date2}' group by concat(year(tup_starttime),'-' ,month(tup_starttime))) intOut on domIntOut.yearMonth = intOut.yearMonth2 union all
select 'SR Telecom Limited' as callDateCalc, domestic DomesticDurationCalc, intIn IntlOutDurationCalc, intOut IntlInDurationCalc  from(select yearMonth, domestic, intIn from(select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth, sum(duration1)/60 domestic from  srtelecom_cas.sum_voice_day_01 where tup_starttime >= '{date1}' and tup_starttime < '{date2}'  group by concat(year(tup_starttime),'-' ,month(tup_starttime))) dom left join (select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth1, sum(duration1)/60 IntIn from   srtelecom_cas.sum_voice_day_03 where tup_starttime >= '{date1}' and tup_starttime < '{date2}' group by concat(year(tup_starttime),'-' ,month(tup_starttime))) intIn  on dom.yearMonth = intIn.yearMonth1 )domIntOut left join (select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth2, sum(duration1)/60 IntOut from   srtelecom_cas.sum_voice_day_02 where tup_starttime >= '{date1}' and tup_starttime < '{date2}' group by concat(year(tup_starttime),'-' ,month(tup_starttime))) intOut on domIntOut.yearMonth = intOut.yearMonth2 union all
select 'Softex communication Ltd' as callDateCalc, domestic DomesticDurationCalc, intIn IntlOutDurationCalc, intOut IntlInDurationCalc  from(select yearMonth, domestic, intIn from(select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth, sum(duration1)/60 domestic from  softex_cas.sum_voice_day_01 where tup_starttime >= '{date1}' and tup_starttime < '{date2}'  group by concat(year(tup_starttime),'-' ,month(tup_starttime))) dom left join (select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth1, sum(duration1)/60 IntIn from   softex_cas.sum_voice_day_03 where tup_starttime >= '{date1}' and tup_starttime < '{date2}' group by concat(year(tup_starttime),'-' ,month(tup_starttime))) intIn  on dom.yearMonth = intIn.yearMonth1 )domIntOut left join (select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth2, sum(duration1)/60 IntOut from   softex_cas.sum_voice_day_02 where tup_starttime >= '{date1}' and tup_starttime < '{date2}' group by concat(year(tup_starttime),'-' ,month(tup_starttime))) intOut on domIntOut.yearMonth = intOut.yearMonth2 union all
select 'Summit Communications Ltd (Vertex)' as callDateCalc, domestic DomesticDurationCalc, intIn IntlOutDurationCalc, intOut IntlInDurationCalc  from(select yearMonth, domestic, intIn from(select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth, sum(duration1)/60 domestic from  summit_cas.sum_voice_day_01 where tup_starttime >= '{date1}' and tup_starttime < '{date2}'  group by concat(year(tup_starttime),'-' ,month(tup_starttime))) dom left join (select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth1, sum(duration1)/60 IntIn from   summit_cas.sum_voice_day_03 where tup_starttime >= '{date1}' and tup_starttime < '{date2}' group by concat(year(tup_starttime),'-' ,month(tup_starttime))) intIn  on dom.yearMonth = intIn.yearMonth1 )domIntOut left join (select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth2, sum(duration1)/60 IntOut from   summit_cas.sum_voice_day_02 where tup_starttime >= '{date1}' and tup_starttime < '{date2}' group by concat(year(tup_starttime),'-' ,month(tup_starttime))) intOut on domIntOut.yearMonth = intOut.yearMonth2 union all
select 'Tele Exchange Limited' as callDateCalc, domestic DomesticDurationCalc, intIn IntlOutDurationCalc, intOut IntlInDurationCalc  from(select yearMonth, domestic, intIn from(select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth, sum(duration1)/60 domestic from  teleexchange_cas.sum_voice_day_01 where tup_starttime >= '{date1}' and tup_starttime < '{date2}'  group by concat(year(tup_starttime),'-' ,month(tup_starttime))) dom left join (select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth1, sum(duration1)/60 IntIn from   teleexchange_cas.sum_voice_day_03 where tup_starttime >= '{date1}' and tup_starttime < '{date2}' group by concat(year(tup_starttime),'-' ,month(tup_starttime))) intIn  on dom.yearMonth = intIn.yearMonth1 )domIntOut left join (select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth2, sum(duration1)/60 IntOut from   teleexchange_cas.sum_voice_day_02 where tup_starttime >= '{date1}' and tup_starttime < '{date2}' group by concat(year(tup_starttime),'-' ,month(tup_starttime))) intOut on domIntOut.yearMonth = intOut.yearMonth2 union all
select 'Teleplus Newyork Limited' as callDateCalc, domestic DomesticDurationCalc, intIn IntlOutDurationCalc, intOut IntlInDurationCalc  from(select yearMonth, domestic, intIn from(select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth, sum(duration1)/60 domestic from teleplusnewyork_cas.sum_voice_day_01 where tup_starttime >= '{date1}' and tup_starttime < '{date2}'  group by concat(year(tup_starttime),'-' ,month(tup_starttime))) dom left join (select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth1, sum(duration1)/60 IntIn from  teleplusnewyork_cas.sum_voice_day_03 where tup_starttime >= '{date1}' and tup_starttime < '{date2}' group by concat(year(tup_starttime),'-' ,month(tup_starttime))) intIn  on dom.yearMonth = intIn.yearMonth1 )domIntOut left join (select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth2, sum(duration1)/60 IntOut from  teleplusnewyork_cas.sum_voice_day_02 where tup_starttime >= '{date1}' and tup_starttime < '{date2}' group by concat(year(tup_starttime),'-' ,month(tup_starttime))) intOut on domIntOut.yearMonth = intOut.yearMonth2 union all
select 'Voicetel Ltd' as callDateCalc, domestic DomesticDurationCalc, intIn IntlOutDurationCalc, intOut IntlInDurationCalc  from(select yearMonth, domestic, intIn from(select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth, sum(duration1)/60 domestic from  voicetel_cas.sum_voice_day_01 where tup_starttime >= '{date1}' and tup_starttime < '{date2}'  group by concat(year(tup_starttime),'-' ,month(tup_starttime))) dom left join (select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth1, sum(duration1)/60 IntIn from   voicetel_cas.sum_voice_day_03 where tup_starttime >= '{date1}' and tup_starttime < '{date2}' group by concat(year(tup_starttime),'-' ,month(tup_starttime))) intIn  on dom.yearMonth = intIn.yearMonth1 )domIntOut left join (select concat(year(tup_starttime),'-' ,month(tup_starttime)) as yearMonth2, sum(duration1)/60 IntOut from   voicetel_cas.sum_voice_day_02 where tup_starttime >= '' and tup_starttime < '{date2}' group by concat(year(tup_starttime),'-' ,month(tup_starttime))) intOut on domIntOut.yearMonth = intOut.yearMonth2 
";
            return livedb;
        }
    }
