<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="True"
    CodeBehind="AllTrafic.aspx.cs" Inherits="CasDefaultRptAllTrafic" %>
    ...
    <script runat="server">
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                {
                    lblScreenTitle.Text = "Reports/DomesticWithLtfs";
                }
        ...
        <ContentTemplate>
            <div id="ParamBorder" style="float: left; padding-top: 3px; padding-left: 10px; height: 155px; display: block; border: 2px ridge #E5E4E2; margin-bottom: 5px; width: 1300px;">
                <div style=" display:none;height: 20px; background-color: #f2f2f2; color: black;">
                    ...
                    <span style="float: left; font-weight: bold; padding-left: 20px; visibility : hidden;">Show Revenue
        ...
        <div style="display:none;float: left; text-align: left; width: 900px; position: relative; top: 0px; padding-left: 5px;">
            ...
            <div style="text-align: center;">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        <asp:BoundField DataField="noofcalls1" HeaderText="Dom Calls" SortExpression="noofcalls1"  ItemStyle-Wrap="false" />   
                        <asp:BoundField DataField="minutes1" HeaderText="Dom Minutes" SortExpression="minutes1" />                
                                 
                        <asp:BoundField DataField="noofcalls2" HeaderText="Int. Out calls" SortExpression="noofcalls2"  ItemStyle-Wrap="false" />   
                        <asp:BoundField DataField="minutes2" HeaderText="Int. Out Minutes" SortExpression="minutes2" />                
                        
                        <asp:BoundField DataField="noofcalls3" HeaderText="Int. In Calls" SortExpression="noofcalls3"  ItemStyle-Wrap="false" />   
                        <asp:BoundField DataField="minutes3" HeaderText="Int. In Minutes" SortExpression="minutes3" />                
