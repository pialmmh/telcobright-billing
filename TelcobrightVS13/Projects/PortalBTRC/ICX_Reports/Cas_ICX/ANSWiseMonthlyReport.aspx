<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="ANSWiseMonthlyReport.aspx.cs" Inherits="PortalApp.ICX_Reports.Cas_ICX.ANSWiseMonthlyReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="display: flex; background-color: #086052; width:643px">
        <div style=" padding: 5px; margin-left: 206px;border: 1px solid #ccc;text-align: center; width:207px; color: white;">Domestic</div>
        <div style=" padding: 5px; border: 1px solid #ccc; width: 206px; text-align: center; color: white;">International</div>        
    </div>
    ...
    <asp:GridView ID="GridView2" runat="server" AllowPaging="false" 
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="ANS" ItemStyle-Width="197px">
                <ItemTemplate>
