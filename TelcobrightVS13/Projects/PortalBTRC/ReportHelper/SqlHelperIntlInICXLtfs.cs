...
{
    public class SqlHelperIntlInIcxLtfs : AbstractSqlHelper
    {
        public SqlHelperIntlInIcxLtfs(string startDate, string endDate, string groupInterval,string tablename,
