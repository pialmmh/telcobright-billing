...
{
    public class SqlHelperIntlInICXv2 : AbstractSqlHelper
    {
        public SqlHelperIntlInICXv2(string startDate, string endDate, string groupInterval,string tablename,
        ...
        public override string getSQLString()
        {
            return $@"
				...
				tup_outgoingroute , 
                tup_switchid ,
                tup_sourceId as ipOrTdm,
                (select '_icxName_') as icxName,
				tup_countryorareacode as zone,
