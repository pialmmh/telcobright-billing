...
{
	public partial class sum_voice_hr_06:ICacheble<sum_voice_hr_06>
	{
		...
		public  StringBuilder GetExtInsertCustom(Func<sum_voice_hr_06,string> externalInsertMethod)
		{
			return new StringBuilder(externalInsertMethod.Invoke(this));
		}
		public  StringBuilder GetUpdateCommand(Func<sum_voice_hr_06,string> whereClauseMethod)
		{
			return new StringBuilder("update sum_voice_hr_06 set ")
		...
		public  StringBuilder GetUpdateCommandCustom(Func<sum_voice_hr_06,string> updateCommandMethodCustom)
		{
			return new StringBuilder(updateCommandMethodCustom.Invoke(this));
		}
		public  StringBuilder GetDeleteCommand(Func<sum_voice_hr_06,string> whereClauseMethod)
		{
			return new StringBuilder($@"delete from sum_voice_hr_06 
