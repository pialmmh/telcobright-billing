...
namespace MediationModel
{
	public partial class sum_voice_hr_06:ICacheble<sum_voice_hr_06>
	{
		...
		public  string GetExtInsertCustom(Func<sum_voice_hr_06,string> externalInsertMethod)
		{
			return externalInsertMethod.Invoke(this);
		}
		public  string GetUpdateCommand(Func<sum_voice_hr_06,string> whereClauseMethod)
		{
			return $@"update sum_voice_hr_06 set 
				id={id.ToMySqlField()+" "},
		...
		public  string GetUpdateCommandCustom(Func<sum_voice_hr_06,string> updateCommandMethodCustom)
		{
			return updateCommandMethodCustom.Invoke(this);
		}
		public  string GetDeleteCommand(Func<sum_voice_hr_06,string> whereClauseMethod)
		{
			return $@"delete from sum_voice_hr_06 
				{whereClauseMethod.Invoke(this)};
				";
		}
	}
