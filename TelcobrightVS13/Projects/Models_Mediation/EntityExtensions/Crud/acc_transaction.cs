...
namespace MediationModel
{
	public partial class acc_transaction:ICacheble<acc_transaction>
	{
		...
		public  string GetExtInsertCustom(Func<acc_transaction,string> externalInsertMethod)
		{
			return externalInsertMethod.Invoke(this);
		}
		public  string GetUpdateCommand(Func<acc_transaction,string> whereClauseMethod)
		{
			return $@"update acc_transaction set 
				id={id.ToMySqlField()+" "},
		...
		public  string GetUpdateCommandCustom(Func<acc_transaction,string> updateCommandMethodCustom)
		{
			return updateCommandMethodCustom.Invoke(this);
		}
		public  string GetDeleteCommand(Func<acc_transaction,string> whereClauseMethod)
		{
			return $@"delete from acc_transaction 
				{whereClauseMethod.Invoke(this)};
				";
		}
	}
