...
{
	public partial class acc_transaction:ICacheble<acc_transaction>
	{
		...
		public  StringBuilder GetExtInsertCustom(Func<acc_transaction,string> externalInsertMethod)
		{
			return new StringBuilder(externalInsertMethod.Invoke(this));
		}
		public  StringBuilder GetUpdateCommand(Func<acc_transaction,string> whereClauseMethod)
		{
			return new StringBuilder("update acc_transaction set ")
		...
		public  StringBuilder GetUpdateCommandCustom(Func<acc_transaction,string> updateCommandMethodCustom)
		{
			return new StringBuilder(updateCommandMethodCustom.Invoke(this));
		}
		public  StringBuilder GetDeleteCommand(Func<acc_transaction,string> whereClauseMethod)
		{
			return new StringBuilder($@"delete from acc_transaction 
