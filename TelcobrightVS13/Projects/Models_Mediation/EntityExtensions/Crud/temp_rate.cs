...
{
	public partial class temp_rate:ICacheble<temp_rate>
	{
		...
		public  StringBuilder GetExtInsertCustom(Func<temp_rate,string> externalInsertMethod)
		{
			return new StringBuilder(externalInsertMethod.Invoke(this));
		}
		public  StringBuilder GetUpdateCommand(Func<temp_rate,string> whereClauseMethod)
		{
			return new StringBuilder("update temp_rate set ")
		...
		public  StringBuilder GetUpdateCommandCustom(Func<temp_rate,string> updateCommandMethodCustom)
		{
			return new StringBuilder(updateCommandMethodCustom.Invoke(this));
		}
		public  StringBuilder GetDeleteCommand(Func<temp_rate,string> whereClauseMethod)
		{
			return new StringBuilder($@"delete from temp_rate 
