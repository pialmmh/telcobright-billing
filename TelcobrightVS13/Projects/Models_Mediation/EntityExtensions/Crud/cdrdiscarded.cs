...
namespace MediationModel
{
	public partial class cdrdiscarded:ICacheble<cdrdiscarded>
	{
		...
		public  string GetExtInsertCustom(Func<cdrdiscarded,string> externalInsertMethod)
		{
			return externalInsertMethod.Invoke(this);
		}
		public  string GetUpdateCommand(Func<cdrdiscarded,string> whereClauseMethod)
		{
			return $@"update cdrdiscarded set 
		...
		public  string GetUpdateCommandCustom(Func<cdrdiscarded,string> updateCommandMethodCustom)
		{
			return updateCommandMethodCustom.Invoke(this);
		}
		public  string GetDeleteCommand(Func<cdrdiscarded,string> whereClauseMethod)
		{
			return $@"delete from cdrdiscarded 
				{whereClauseMethod.Invoke(this)};
				";
		}
	}
