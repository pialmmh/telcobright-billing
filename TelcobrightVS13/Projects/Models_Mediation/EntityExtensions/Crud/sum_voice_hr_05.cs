...
{
	public partial class sum_voice_hr_05:ICacheble<sum_voice_hr_05>
	{
		...
		public  StringBuilder GetExtInsertCustom(Func<sum_voice_hr_05,string> externalInsertMethod)
		{
			return new StringBuilder(externalInsertMethod.Invoke(this));
		}
		public  StringBuilder GetUpdateCommand(Func<sum_voice_hr_05,string> whereClauseMethod)
		{
			return new StringBuilder("update sum_voice_hr_05 set ")
		...
		public  StringBuilder GetUpdateCommandCustom(Func<sum_voice_hr_05,string> updateCommandMethodCustom)
		{
			return new StringBuilder(updateCommandMethodCustom.Invoke(this));
		}
		public  StringBuilder GetDeleteCommand(Func<sum_voice_hr_05,string> whereClauseMethod)
		{
			return new StringBuilder($@"delete from sum_voice_hr_05 
