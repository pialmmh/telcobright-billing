...
namespace MediationModel
{
	public partial class ratetaskassign:ICacheble<ratetaskassign>
	{
		...
		public  StringBuilder GetExtInsertCustom(Func<ratetaskassign,string> externalInsertMethod)
		{
			return new StringBuilder(externalInsertMethod.Invoke(this));
		}
		public  StringBuilder GetUpdateCommand(Func<ratetaskassign,string> whereClauseMethod)
		{
			return new StringBuilder("update ratetaskassign set ")
				...
				.Append("Comment2=").Append(this.Comment2.ToMySqlField())
				.Append(whereClauseMethod.Invoke(this));
				
		}
		public  StringBuilder GetUpdateCommandCustom(Func<ratetaskassign,string> updateCommandMethodCustom)
		{
			return new StringBuilder(updateCommandMethodCustom.Invoke(this));
		}
		public  StringBuilder GetDeleteCommand(Func<ratetaskassign,string> whereClauseMethod)
		{
			return new StringBuilder($@"delete from ratetaskassign 
