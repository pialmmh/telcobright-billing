...
namespace MediationModel
{
	public partial class sum_voice_hr_04:ICacheble<sum_voice_hr_04>
	{
		...
		public  string GetExtInsertCustom(Func<sum_voice_hr_04,string> externalInsertMethod)
		{
			return externalInsertMethod.Invoke(this);
		}
		public  string GetUpdateCommand(Func<sum_voice_hr_04,string> whereClauseMethod)
		{
			return $@"update sum_voice_hr_04 set 
				id={id.ToMySqlField()+" "},
		...
		public  string GetUpdateCommandCustom(Func<sum_voice_hr_04,string> updateCommandMethodCustom)
		{
			return updateCommandMethodCustom.Invoke(this);
		}
		public  string GetDeleteCommand(Func<sum_voice_hr_04,string> whereClauseMethod)
		{
			return $@"delete from sum_voice_hr_04 
				{whereClauseMethod.Invoke(this)};
				";
		}
	}
