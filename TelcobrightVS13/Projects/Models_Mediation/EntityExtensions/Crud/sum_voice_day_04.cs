...
{
	public partial class sum_voice_day_04:ICacheble<sum_voice_day_04>
	{
		...
		public  StringBuilder GetExtInsertCustom(Func<sum_voice_day_04,string> externalInsertMethod)
		{
			return new StringBuilder(externalInsertMethod.Invoke(this));
		}
		public  StringBuilder GetUpdateCommand(Func<sum_voice_day_04,string> whereClauseMethod)
		{
			return new StringBuilder("update sum_voice_day_04 set ")
		...
		public  StringBuilder GetUpdateCommandCustom(Func<sum_voice_day_04,string> updateCommandMethodCustom)
		{
			return new StringBuilder(updateCommandMethodCustom.Invoke(this));
		}
		public  StringBuilder GetDeleteCommand(Func<sum_voice_day_04,string> whereClauseMethod)
		{
			return new StringBuilder($@"delete from sum_voice_day_04 
