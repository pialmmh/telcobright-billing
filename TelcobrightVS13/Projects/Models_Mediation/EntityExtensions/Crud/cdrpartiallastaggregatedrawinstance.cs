	...
	public partial class cdrpartiallastaggregatedrawinstance:ICacheble<cdrpartiallastaggregatedrawinstance>
	{
		public string GetExtInsertValues()
		{
			return $@"(
				...
				{this.AreaCodeOrLata.ToMySqlField()},
				...
				{this.AdditionalSystemCodes.ToMySqlField()},
				{this.AdditionalPartyNumber.ToMySqlField()},
				{this.ResellerIds.ToMySqlField()},
				{BTRCTermRate.ToMySqlField()},
				{this.PreviousRoutes.ToMySqlField()},
				{E1Id.ToMySqlField()},
				...
				{this.AdditionalMetaData.ToMySqlField()},
		...
		public  string GetExtInsertCustom(Func<cdrpartiallastaggregatedrawinstance,string> externalInsertMethod)
		{
			return externalInsertMethod.Invoke(this);
		}
		public  string GetUpdateCommand(Func<cdrpartiallastaggregatedrawinstance,string> whereClauseMethod)
		{
			return $@"update cdrpartiallastaggregatedrawinstance set 
				...
				CustomerPrePaid={this.PrePaid.ToMySqlField()+" "},
				...
				MinuteID={this.AreaCodeOrLata.ToMySqlField()+" "},
				...
				CostVATCommissionIn={this.Tax1.ToMySqlField()+" "},
				...
				RevenueVATCommissionOut={this.Tax2.ToMySqlField()+" "},
				...
				GrpDayId={this.AdditionalSystemCodes.ToMySqlField()+" "},
				MonthId={this.AdditionalPartyNumber.ToMySqlField()+" "},
				DayId={this.ResellerIds.ToMySqlField()+" "},
				BTRCTermRate={BTRCTermRate.ToMySqlField()+" "},
				WeekDayId={this.PreviousRoutes.ToMySqlField()+" "},
				...
				BillngInfo={this.AdditionalMetaData.ToMySqlField()+" "},
		...
		public  string GetUpdateCommandCustom(Func<cdrpartiallastaggregatedrawinstance,string> updateCommandMethodCustom)
		{
			return updateCommandMethodCustom.Invoke(this);
		}
		public  string GetDeleteCommand(Func<cdrpartiallastaggregatedrawinstance,string> whereClauseMethod)
		{
			return $@"delete from cdrpartiallastaggregatedrawinstance 
				{whereClauseMethod.Invoke(this)};
				";
		}
	}
