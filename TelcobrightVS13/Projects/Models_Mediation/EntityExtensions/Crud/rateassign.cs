	...
	public partial class rateassign:ICacheble<rateassign>
	{
		public string GetExtInsertValues()
		{
			return $@"(
				...
				{BillingParams.ToMySqlField()}
				)";
		}
		public  string GetExtInsertCustom(Func<rateassign,string> externalInsertMethod)
		{
			return externalInsertMethod.Invoke(this);
		}
		public  string GetUpdateCommand(Func<rateassign,string> whereClauseMethod)
		{
			return $@"update rateassign set 
				id={id.ToMySqlField()+" "},
				...
				BillingParams={BillingParams.ToMySqlField()+" "}
				{whereClauseMethod.Invoke(this)};
				";
		}
		public  string GetUpdateCommandCustom(Func<rateassign,string> updateCommandMethodCustom)
		{
			return updateCommandMethodCustom.Invoke(this);
		}
		public  string GetDeleteCommand(Func<rateassign,string> whereClauseMethod)
		{
			return $@"delete from rateassign 
				{whereClauseMethod.Invoke(this)};
				";
		}
	}
