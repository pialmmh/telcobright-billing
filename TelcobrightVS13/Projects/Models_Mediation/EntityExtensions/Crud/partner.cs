	...
	public partial class partner:ICacheble<partner>
	{
		public StringBuilder GetExtInsertValues()
		{
			return new StringBuilder("(")
				...
				.Append(this.AlternateNameInvoice.ToMySqlField()).Append(",")
				.Append(this.AlternateNameOther.ToMySqlField()).Append(",")
		...
		public  StringBuilder GetUpdateCommand(Func<partner,string> whereClauseMethod)
		{
			return new StringBuilder("update partner set ")
				...
				.Append("AlternateNameInvoice=").Append(this.AlternateNameInvoice.ToMySqlField()).Append(",")
				.Append("AlternateNameOther=").Append(this.AlternateNameOther.ToMySqlField()).Append(",")
