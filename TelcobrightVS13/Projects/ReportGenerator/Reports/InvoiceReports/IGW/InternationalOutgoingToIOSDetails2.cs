...
namespace ReportGenerator.Reports.InvoiceReports.IGW
{
    ...
    public partial class InternationalOutgoingToIOSDetails2 : DevExpress.XtraReports.UI.XtraReport, IInvoiceTemplate
    {
        public string TemplateName => this.GetType().Name;

        public InternationalOutgoingToIOSDetails2()
        {
            InitializeComponent();
        }
