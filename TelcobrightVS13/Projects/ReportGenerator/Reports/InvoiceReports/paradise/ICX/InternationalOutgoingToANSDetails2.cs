...
namespace TelcobrightMediation.Reports.InvoiceReports.paradise.ICX
{
    ...
    public partial class InternationalOutgoingToANSDetails2 : DevExpress.XtraReports.UI.XtraReport, IInvoiceTemplate
    {
        ...
        public void GenerateInvoice(object data)
        {
            ...
            xrTableCell9.DataBindings.Add("Text", this.DataSource, "TotalCalls", "{0:n0}");
            xrTableCell10.DataBindings.Add("Text", this.DataSource, "TotalMinutes", "{0:n2}");
            xrTableCell13.DataBindings.Add("Text", this.DataSource, "XAmount", "{0:n2}");
            xrTableCell14.DataBindings.Add("Text", this.DataSource, "YAmount", "{0:n2}");
            xrTableCell15.DataBindings.Add("Text", this.DataSource, "XYAmount", "{0:n2}");
