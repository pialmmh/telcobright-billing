...
namespace TelcobrightMediation.Reports.InvoiceReports.paradise.ICX
{
    ...
    public partial class DomesticToANSDetails1 : DevExpress.XtraReports.UI.XtraReport, IInvoiceTemplate
    {
        ...
        public void GenerateInvoice(object data)
        {
            ...
            if (invoiceBasicDatasMerged != null && invoiceBasicDatasMerged.Count == 2)
            {
            ...
            if (invoiceBasicDatasMerged != null && invoiceBasicDatasMerged.Count == 3)
            {
                ...
                xrTableCell9.DataBindings.Add("Text", invoiceBasicDatasMerged[2], "InPartnerName");
                xrTableCell16.DataBindings.Add("Text", invoiceBasicDatasMerged[2], "TotalCalls", "{0:n0}");
                xrTableCell23.DataBindings.Add("Text", invoiceBasicDatasMerged[2], "TotalMinutes", "{0:n2}");
                xrTableCell30.DataBindings.Add("Text", invoiceBasicDatasMerged[2], "Rate", "{0:##0.######}");
                xrTableCell31.DataBindings.Add("Text", invoiceBasicDatasMerged[2], "Amount", "{0:n2}");
                xrTableCell32.DataBindings.Add("Text", invoiceBasicDatasMerged[2], "GrandTotalAmount", "{0:n2}");
