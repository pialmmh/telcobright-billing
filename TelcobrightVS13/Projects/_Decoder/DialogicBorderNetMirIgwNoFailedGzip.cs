...
namespace Decoders
{
    ...
    public class DialogicBorderNetMirIgwNoFailedGzip : DialogicBorderNetMirIgwNoFailed
    {
        public override string ToString() => this.RuleName;
        public override string RuleName => GetType().Name;
        public override int Id => 235;
        public override string HelpText => "Decodes Dialogic BorderNet CSV CDR with Gzip (Mir Telecom (IGW))";
