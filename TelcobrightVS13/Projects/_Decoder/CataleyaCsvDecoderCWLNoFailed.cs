...
namespace Decoders
{
    ...
    public class CataleyaCsvDecoderCWLNoFailed : AbstractCdrDecoder
    {
        public override string ToString() => this.RuleName;
        public override string RuleName => GetType().Name;
        public override int Id => 40;
        public override string HelpText => "Decodes Cataleya CSV CDR. CrossWorld format, no failed calls";
