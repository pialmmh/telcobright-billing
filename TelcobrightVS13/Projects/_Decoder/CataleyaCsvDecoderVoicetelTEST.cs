...
namespace Decoders
{
    ...
    public class CataleyaCsvDecoderVoicetelTEST : AbstractCdrDecoder
    {
        public override string ToString() => this.RuleName;
        public override string RuleName => GetType().Name;
        public override int Id => 711;
        public override string HelpText => "Decodes Cataleya CSV CDR. Voicetel format, no failed calls";
