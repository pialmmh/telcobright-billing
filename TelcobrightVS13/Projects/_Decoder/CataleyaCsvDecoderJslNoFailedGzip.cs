...
namespace Decoders
{
    ...
    public class CataleyaCsvDecoderJslNoFailedGzip : CataleyaCsvDecoderJslNoFailed
    {
        public override string ToString() => this.RuleName;
        public override string RuleName => GetType().Name;
        public override int Id => 270;
        public override string HelpText => "Decodes Cataleya CSV CDR. JSL format, no failed calls Gzip";
