...
namespace Decoders
{
    ...
    public class DialogicBorderNetSummitWithFailedGzip : DialogicBorderNetSummitWithFailed
    {
        public override string ToString() => this.RuleName;
        public override string RuleName => GetType().Name;
        public override int Id => 3500;
        public override string HelpText => "Decodes Dialogic BorderNet CSV CDR with Gzip (Summit Telecom)";
