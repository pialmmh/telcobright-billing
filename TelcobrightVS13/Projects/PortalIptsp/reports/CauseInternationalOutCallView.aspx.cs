...
public partial class DefaultCIntlOutCallView1 : System.Web.UI.Page
{
    string _startdate = "";
    string _enddate = "";
    string _country = "";
    ...
    private string Querybuilder()
    {
        ...
        sqlstring = "Select OriginatingCalledNumber,OriginatingCallingNumber,TerminatingCalledNumber,TerminatingCallingNumber,IncomingRoute,OutgoingRoute,StartTime,ConnectTime,EndTime,DurationSec as ActualDuration,RoundedDuration,"+ causeCodeFieldName +" as Cause from cdr where ServiceGroup=5"; //,CustomerID as ICX,SupplierID as Partner,AnsIDOrig as ANS
        ...
        if (this._ans!="")
        {            
            sqlstring += " and AnsIdOrig='"+ this._ansid+"'";
        }
        if (this._icx!="")
        {
    ...
    public static void ExportToSpreadsheet(DataTable table, string name)
    {
        ...
        CreateExcelFileAspNet.CreateExcelDocumentAsStreamEpPlusPackageLastRowSummary(table, "CauseCodeWiseCallsIntlOut_" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss")
