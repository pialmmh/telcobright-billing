                    ...
                    foreach (job thisJob in lstIncomplete)
                    {
                        ...
                        catch (Exception e1)
                        {
                            ...
                            try
                            {
                                ...
                                ErrorWriter wr = new ErrorWriter(e1, "ProcessFileCopy", thisJob, "", operatorName,context);
                                ...
                                {
                                    ErrorWriter wr2 = new ErrorWriter(e2, "ProcessFileCopy", null, "", operatorName,context);
                                }
