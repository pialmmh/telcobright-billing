...
{
    public class CommonMdrValRulesGen : CommonCdrValRulesGen
    {
        private DateTime NotAllowedCallDateTimeBefore { get; }

        public CommonMdrValRulesGen(DateTime notAllowedCallDateTimeBefore) 
            : base(notAllowedCallDateTimeBefore)
        {
            this.NotAllowedCallDateTimeBefore = notAllowedCallDateTimeBefore;
        }

        public override List<IValidationRule<cdr>> GetRules()
        {
