...
namespace InstallConfig
{
    ...
    {
        public static MySqlCluster getAgniBanglatelBantel()
        {
            
            string profileName = "AgniBanglatelBantel";

            MySqlCluster MySqlCluster = new MySqlCluster
            {
                Master = new MySqlServer("01AgniBanglatelBantel")
                {
                    MySqlVersion = MySqlVersion.MySql57,
                    BindAddressForAutomation = new BindAddress
                    {
                        IpAddressOrHostName = new IpAddressOrHostName {Address = "172.16.1.21"},
                        Port = 3306
                    },
