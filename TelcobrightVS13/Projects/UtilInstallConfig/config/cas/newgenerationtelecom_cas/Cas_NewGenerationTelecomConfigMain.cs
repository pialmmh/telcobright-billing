...
namespace InstallConfig
{
    ...
    public partial class CasNewGenerationTelecomAbstractConfigGenerator : AbstractConfigGenerator
    {
        public override TelcobrightConfig Tbc { get; set; }
        public CasNewGenerationTelecomAbstractConfigGenerator()
        {
            this.Tbc = new TelcobrightConfig(TelecomOperatortype.Icx,CasTbPartnerFactory.GetTemplatePartner(23, "New Generation Telecom Ltd. ", "newgenerationtelecom_cas"));
        }
