    ...
    public sealed partial class CasCrossWorldAbstractConfigGenerator//quartz config part
    {
        ...
        public void PrepareDirectorySettings(TelcobrightConfig tbc)
        {
            ...
            FileLocation vaultCataleya = new FileLocation()
            {
                ...
                PathSeparator = @"\",
                ServerIp = "",
                StartingPath = "D:/telcobright/vault/resources/cdr/crossworld/ip",
                User = "",
                Pass = "",
            };
            FileLocation vaultGenband = new FileLocation()
            {
                ...
                PathSeparator = @"\",
                ServerIp = "",
                StartingPath = "D:/telcobright/vault/resources/cdr/crossworld/tdm",
                User = "",
                Pass = "",
            };
            FileLocation vaultTelcobridgeCTG = new FileLocation()
            {
                ...
                PathSeparator = @"\",
                ServerIp = "",
                StartingPath = "D:/telcobright/vault/resources/cdr/crossworld/tdm1/CTG",
                User = "",
                Pass = "",
            };
            ...
            FileLocation vaultTelcobridgeKHL = new FileLocation()
            {
                ...
                PathSeparator = @"\",
                ServerIp = "",
                StartingPath = "D:/telcobright/vault/resources/cdr/crossworld/tdm1/KHL",
                User = "",
                Pass = "",
            };
