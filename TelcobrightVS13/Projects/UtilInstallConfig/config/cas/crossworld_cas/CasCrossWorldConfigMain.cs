...
namespace InstallConfig
{
    ...
    public partial class CasCrossWorldAbstractConfigGenerator : AbstractConfigGenerator
    {
        public override TelcobrightConfig Tbc { get; set; }
        public CasCrossWorldAbstractConfigGenerator()
        {
            this.Tbc = new TelcobrightConfig(TelecomOperatortype.Icx,CasTbPartnerFactory.GetTemplatePartner(18, "CrossWorld Telecom Ltd.","crossworld_cas"));
