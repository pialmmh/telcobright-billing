...
namespace InstallConfig
{
    ...
    public partial class CasMmCommunicationsAbstractConfigGenerator //quartz config part
    {
        public void PrepareDirectorySettings(TelcobrightConfig tbc)
        {
            DirectorySettings directorySetting = new DirectorySettings("f:/telcobright", @"cas\casDbF");
            ...
            FileLocation vaultJslZteDhk = new FileLocation()
            {
                ...
                PathSeparator = @"\",
                ServerIp = "",
                StartingPath = "F:/telcobright/vault/resources/cdr/mmcommunications/tdm",
                User = "",
                Pass = "",
            };
