...
namespace InstallConfig
{
    ...
    public sealed partial class CasImamNetworkAbstractConfigGenerator : AbstractConfigGenerator
    {
        public override TelcobrightConfig Tbc { get; set; }
        public override int IdOperator { get; set; } = 8;
        public override string CustomerName { get; set; } = "Imam Network Ltd.";
        public override string DatabaseName { get; set; } = "imamnetwork_cas";
