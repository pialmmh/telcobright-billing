...
namespace InstallConfig
{
    ...
    public sealed partial class CasMmCommunicationsAbstractConfigGenerator : AbstractConfigGenerator
    {
        public override TelcobrightConfig Tbc { get; set; }
        public override int IdOperator { get; set; } = 10;
        public override string CustomerName { get; set; }  = "MM Communications Ltd" ;
        public override string DatabaseName { get; set; } = "mmcommunications_cas";

        public CasMmCommunicationsAbstractConfigGenerator()
        {
