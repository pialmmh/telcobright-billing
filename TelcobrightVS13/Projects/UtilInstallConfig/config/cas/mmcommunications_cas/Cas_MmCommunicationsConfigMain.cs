...
namespace InstallConfig
{
    ...
    public partial class CasMmCommunicationsAbstractConfigGenerator : AbstractConfigGenerator
    {
        public override TelcobrightConfig Tbc { get; set; }
        public CasMmCommunicationsAbstractConfigGenerator()
        {
            this.Tbc = new TelcobrightConfig(TelecomOperatortype.Icx,CasTbPartnerFactory.GetTemplatePartner(10, "MM Communications Ltd", "mmcommunications_cas"));
        }
