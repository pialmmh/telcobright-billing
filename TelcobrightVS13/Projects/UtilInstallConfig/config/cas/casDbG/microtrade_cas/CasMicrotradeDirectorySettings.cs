...
namespace InstallConfig
{
    ...
    public partial class CasMicrotradeAbstractConfigGenerator //quartz config part
    {
        ...
        {
            DirectorySettings directorySetting = new DirectorySettings("g:/telcobright", @"cas\casDbG");
            ...
            FileLocation vaultJslZteDhk = new FileLocation()
            {
                ...
                PathSeparator = @"\",
                ServerIp = "",
                StartingPath = "G:/telcobright/vault/resources/cdr/microtrade/tdm",
                User = "",
                Pass = "",
            };
            ...
            FileLocation vaultJslcataliyaDhk = new FileLocation()
            {
                ...
                PathSeparator = @"\",
                ServerIp = "",
                StartingPath = "G:/telcobright/vault/resources/cdr/microtrade/ip",
                User = "",
                Pass = "",
            };
