...
namespace InstallConfig
{
    ...
    public partial class CasMicrotradeAbstractConfigGenerator : AbstractConfigGenerator
    {
        public override TelcobrightConfig Tbc { get; set; }
        public CasMicrotradeAbstractConfigGenerator()
        {
            this.Tbc = new TelcobrightConfig(TelecomOperatortype.Icx,
                new telcobrightpartner
                {
                    idCustomer = 7,
                    CustomerName = "Microtrade Solutions Ltd.",
                    idOperatorType = 2,
                    databasename = "microtrade_cas",
                    databasetype = "mysql",
                    user = "root",
                    pass = null,
                    ServerNameOrIP = null,
