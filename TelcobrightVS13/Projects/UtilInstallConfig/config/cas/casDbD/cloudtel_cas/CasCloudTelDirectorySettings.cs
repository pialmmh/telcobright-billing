...
namespace InstallConfig
{
    ...
    public partial class CasCloudTelAbstractConfigGenerator //quartz config part
    {
        public void PrepareDirectorySettings(TelcobrightConfig tbc)
        {
            DirectorySettings directorySetting = new DirectorySettings("d:/telcobright", @"cas\casDbD");
            ...
            FileLocation vaultJslZteDhk = new FileLocation()
            {
                ...
                PathSeparator = @"\",
                ServerIp = "",
                StartingPath = "D:/telcobright/vault/resources/cdr/cloudtel/tdm",
                User = "",
                Pass = "",
            };
            ...
            FileLocation vaultJslcataliyaDhk = new FileLocation()
            {
                ...
                PathSeparator = @"\",
                ServerIp = "",
                StartingPath = "D:/telcobright/vault/resources/cdr/cloudtel/ip",
                User = "",
                Pass = "",
            };
