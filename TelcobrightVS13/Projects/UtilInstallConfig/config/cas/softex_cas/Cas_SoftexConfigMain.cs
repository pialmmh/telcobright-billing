...
namespace InstallConfig
{
    ...
    public sealed partial class CasSoftexAbstractConfigGenerator : AbstractConfigGenerator
    {
        public override TelcobrightConfig Tbc { get; set; }
        public override int IdOperator { get; set; } = 21;
        public override string CustomerName { get; set; } = "Softex Communications Ltd.";
        public override string DatabaseName { get; set; } = "softex_cas";
