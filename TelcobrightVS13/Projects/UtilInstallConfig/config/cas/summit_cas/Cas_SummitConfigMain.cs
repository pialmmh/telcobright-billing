...
namespace InstallConfig
{
    ...
    public partial class CasSummitAbstractConfigGenerator : AbstractConfigGenerator
    {
        public override TelcobrightConfig Tbc { get; set; }
        public CasSummitAbstractConfigGenerator()
        {
            this.Tbc = new TelcobrightConfig(TelecomOperatortype.Icx,CasTbPartnerFactory.GetTemplatePartner(26, "Summit Communications Ltd.", "summit_cas"));
