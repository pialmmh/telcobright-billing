...
namespace InstallConfig
{
    ...
    public sealed partial class CasSummitAbstractConfigGenerator : AbstractConfigGenerator
    {
        public override TelcobrightConfig Tbc { get; set; }
        public override int IdOperator { get; set; } = 26;
        public override string CustomerName { get; set; } = "Summit Communications Ltd.";
        public override string DatabaseName { get; set; } = "summit_cas";

        public CasSummitAbstractConfigGenerator()
        {
        ...
        public override TelcobrightConfig GenerateFullConfig(InstanceConfig instanceConfig, int microserviceInstanceId)
        {
            ...
            this.Tbc.DatabaseSetting = GetDatabaseConfigs();
