...
namespace InstallConfig
{
    ...
    public sealed partial class CasMnHAbstractConfigGenerator : AbstractConfigGenerator
    {
        public override TelcobrightConfig Tbc { get; set; }
        public override int IdOperator { get; set; } = 11;
        public override string CustomerName { get; set; } = "M&H Telecom Ltd.";
        public override string DatabaseName { get; set; } = "mnh_cas";

        public CasMnHAbstractConfigGenerator()
        {
