...
namespace InstallConfig
{
    ...
    public partial class CasBtclAbstractConfigGenerator : AbstractConfigGenerator
    {
        public override TelcobrightConfig Tbc { get; set; }
        public CasBtclAbstractConfigGenerator()
        {
            this.Tbc = new TelcobrightConfig(TelecomOperatortype.Icx,CasTbPartnerFactory.GetTemplatePartner(12, "Bangladesh Telecommunications Company Limited", "btcl_cas"));
        }
