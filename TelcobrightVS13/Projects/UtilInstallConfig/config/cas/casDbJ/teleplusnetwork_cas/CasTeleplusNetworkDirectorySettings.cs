...
{
    public partial class CasTeleplusNetworkAbstractConfigGenerator //quartz config part
    {
        ...
        {
            DirectorySettings directorySetting = new DirectorySettings("Directory Settings", @"cas\casDbJ");
            ...
            this.vaultPrimary = new FileLocation()
            {
                ...
                PathSeparator = @"\",
                ServerIp = "",
                StartingPath = "J:/telcobright/vault/resources/cdr/teleplusnetwork/tdm",
                User = "",
                Pass = "",
            };
            ...
            this.vaultDialogic = new FileLocation()
            {
                ...
                PathSeparator = @"\",
                ServerIp = "",
                StartingPath = "J:/telcobright/vault/resources/cdr/teleplusnetwork/ip",
                User = "",
                Pass = "",
            };
