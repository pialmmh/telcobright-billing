...
{
    public partial class CasMotherTelecomAbstractConfigGenerator //quartz config part
    {
        ...
        public void PrepareDirectorySettings(TelcobrightConfig tbc)
        {
            ...
            this.vaultPrimary = new FileLocation()
            {
                ...
                PathSeparator = @"\",
                ServerIp = "",
                StartingPath = "J:/telcobright/vault/resources/cdr/mothertelecom/tdm",
                User = "",
                Pass = "",
            };
            ...
            this.vaultDialogic = new FileLocation()
            {
                ...
                PathSeparator = @"\",
                ServerIp = "",
                StartingPath = "J:/telcobright/vault/resources/cdr/mothertelecom/ip",
                User = "",
                Pass = "",
            };
