...
namespace InstallConfig
{
    ...
    public sealed partial class CasVoicetelAbstractConfigGenerator : AbstractConfigGenerator
    {
        public override TelcobrightConfig Tbc { get; set; }
        public override int IdOperator { get; set; } = 27;
        public override string CustomerName { get; set; } = "Voicetel Ltd.";
        public override string DatabaseName { get; set; } = "voicetel_cas";

        public CasVoicetelAbstractConfigGenerator()
        {
