...
namespace InstallConfig
{
    ...
    public partial class CasVoicetelAbstractConfigGenerator : AbstractConfigGenerator
    {
        public override TelcobrightConfig Tbc { get; set; }
        public CasVoicetelAbstractConfigGenerator()
        {
            this.Tbc = new TelcobrightConfig(TelecomOperatortype.Icx,CasTbPartnerFactory.GetTemplatePartner(27, "Voicetel Ltd.", "voicetel_cas"));
