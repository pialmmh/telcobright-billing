...
{
    public sealed partial class CasBanglaTelecomAbstractConfigGenerator //quartz config part
    {
        public override List<Server> GetServerConfigs()//e.g. {"master", server}
        {
            ...
            {
                IpAddresses = new List<IpAddressOrHostName>() { new IpAddressOrHostName { Address = "192.168.0.137" } },
