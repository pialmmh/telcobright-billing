...
namespace InstallConfig
{
    ...
    public sealed partial class CasBanglaTelecomAbstractConfigGenerator : AbstractConfigGenerator
    {
        public override TelcobrightConfig Tbc { get; set; }
        public override int IdOperator { get; set; } = 2;
        public override string CustomerName { get; set; } = "Bangla Telecom Ltd.";
        public override string DatabaseName { get; set; } = "banglatelecom_cas";
