    ...
    public partial class PurpleAbstractConfigConfigGenerator //quartz config part
    {
        public override DatabaseSetting GetDatabaseSettings()
        {
            var databaseSetting = new DatabaseSetting()
            {
                ...
                PartitionStartDate = new DateTime(2023, 6, 1),
            ...
            {
                {
                    "mysqld", new List<string>
                    {
                        ...
                        "server-id= 1",
                        "log-bin= C:/mysql/binlog/master-log-bin",
                        "#log-bin-index=C:/mysql/binlog/master-bin.index",
                        "binlog_format= MIXED",
                ...
                },
                {
                    ...
                    {
                        "log-error=C:/mysql/data/mysql/mysqld.log",
                        "#pid-file= /var/run/mysqld/mysqld.pid",
                    }
