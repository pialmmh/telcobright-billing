...
namespace RateSheetFormat
{
    ...
    public class RsDeutschetelekom : IRateSheetFormat//change here
    {
        public override string ToString()
        {
            return this.RuleName;
        }
        private string _helpText = "Rate Sheet Format for Deutschetelekom";//change for each extension
        public string RuleName
        {
            get { return "rsFormatDeutschetelekom"; }//change for each extension
        }
        ...
        public int Id
        {
            get { return 7; }//change for each extension
        }
        ...
        public RsDeutschetelekom()//change here
        {
            //
