...
namespace RateSheetFormat
{
    ...
    public class RsBharti : IRateSheetFormat
    {
        public override string ToString()
        {
            return this.RuleName;
        }
        private string _helpText = "Rate Sheet Format for Bharti";//change for each extension
        public string RuleName
        {
            get { return "rsFormatBharti"; }//change for each extension
        }
        ...
        public class SheetImportTask
        {
            ...
            public string GetRateArray(ref List<ratetask> lstRateTask, rateplan rp, Workbook book, string[] dateFormats, ref string dateSeparator)
            {
                try
                {
                    ...
                    GetVendorParams(objArray, this.FirstRow);
                    ...
                    {
                        this.VFormat = VendorFormat.Bharti;//GetVendorFormat(ref objArray, FirstRow, book);
                    }
                    else
                    {
            ...
            void GetVendorParams(object[,] objArray, int firstRow)
            {
                int dim2 = objArray.GetLength(1);
