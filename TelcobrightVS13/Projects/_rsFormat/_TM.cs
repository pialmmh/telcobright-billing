...
namespace RateSheetFormat
{
    ...
    public class RsTm : IRateSheetFormat//change here
    {
        public override string ToString()
        {
            return this.RuleName;
        }
        private string _helpText = "Rate Sheet Format for Telecom Malaysia";//change for each extension
        public string RuleName
        {
            get { return "rsFormatTM"; }//change for each extension
        }
        ...
        public int Id
        {
            get { return 9; }//change for each extension
        }
        ...
        public string GetRates(string filePath, ref List<ratetask> lstRateTask, rateplan rp, bool endAllPrevPrefix, string[] dateFormats)
        {
            //try
            {
                ...
                sheet1 = (Worksheet)book.Worksheets[3];//sheet3 for TM
