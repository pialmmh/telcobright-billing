...
namespace RateSheetFormat
{
    ...
    public class RsMainberg : IRateSheetFormat
    {
        public override string ToString()
        {
            return this.RuleName;
        }
        private string _helpText = "Rate Sheet Format for Mainberg";//change for each extension
        public string RuleName
        {
            get { return "rsFormatMainberg"; }//change for each extension
        }
        ...
        public int Id
        {
            get { return 4; }//change for each extension
        }
