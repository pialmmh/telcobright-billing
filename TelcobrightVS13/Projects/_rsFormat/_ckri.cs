...
namespace RateSheetFormat
{
    ...
    public class RsCkri : IRateSheetFormat//change here
    {
        public override string ToString()
        {
            return this.RuleName;
        }
        private string _helpText = "Rate Sheet Format for CKRI";//change for each extension
        public string RuleName
        {
            get { return "rsFormatCkri"; }//change for each extension
        }
        ...
        public int Id
        {
            get { return 5; }//change for each extension
        }
