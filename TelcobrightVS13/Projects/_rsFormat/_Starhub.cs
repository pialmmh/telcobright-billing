...
namespace RateSheetFormat
{
    ...
    public class RsStarhub : IRateSheetFormat//change here
    {
        public override string ToString()
        {
            return this.RuleName;
        }
        private string _helpText = "Rate Sheet Format for Starhub";//change for each extension
        public string RuleName
        {
            get { return "rsFormatStarhub"; }//change for each extension
        }
        ...
        public int Id
        {
            get { return 10; }//change for each extension
        }
        ...
        public string GetRates(string filePath, ref List<ratetask> lstRateTask, rateplan rp, bool endAllPrevPrefix, string[] dateFormats)
        {
            //try
            {
                ...
                sheet1 = (Worksheet)book.Worksheets[2];//sheet2 for starhub

                SheetImportTask importTask1 = new SheetImportTask(ImportTaskType.RateChanges,
                    sheet1, this.DicCountryCode, this.DicCountryName, rp);
                ...
                importTask1.GetRateArray(objArray1, ref lstRateTask, rp, book, dateFormats, ref dateSeparator, firstRow1);

                //for singtel , supersede all prefix
                endAllPrevPrefix = false;
                ...
                if (endAllPrevPrefix == true)
                {
                    ...
                    delTask.startdate = DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss");//delete date, will be set in createnewrate method in the ratetask.aspx.cs
