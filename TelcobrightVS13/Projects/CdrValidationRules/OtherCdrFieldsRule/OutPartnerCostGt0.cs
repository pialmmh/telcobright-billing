...
namespace CdrValidationRules
{
    ...
    public class OutPartnerCostGt0 : IValidationRule<cdr>
    {
        public override string ToString() => this.RuleName;
        public string RuleName => GetType().Name;
        public string ValidationMessage => 
            $@"OutPartnerCost must be > 0 when DurationSec >= {this.minDurationSec}";
        ...
        public bool Validate(cdr obj)
        {
            ...
            return obj.DurationSec >= this.minDurationSec ? obj.OutPartnerCost > 0 : obj.OutPartnerCost == 0;
        }
    }
}
