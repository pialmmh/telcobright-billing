...
namespace CdrValidationRules
{
    ...
    public class RoundedDurationGt0 : IValidationRule<cdr>
    {
        public override string ToString() => this.RuleName;
        public string RuleName => GetType().Name;
        public string ValidationMessage =>
            $@"roundedduration must be > 0 when DurationSec >= {this.minDurationSec}";
        ...
        public bool Validate(cdr obj)
        {
            ...
            return obj.DurationSec >= this.minDurationSec ? obj.RoundedDuration > 0M : obj.RoundedDuration == 0M;
        }
    }
}
