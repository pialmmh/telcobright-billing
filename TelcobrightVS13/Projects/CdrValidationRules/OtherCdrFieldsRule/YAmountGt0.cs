...
namespace CdrValidationRules
{
    ...
    public class YAmountGt0 : IValidationRule<cdr>
    {
        public override string ToString() => this.RuleName;
        public string RuleName => GetType().Name;
        public string ValidationMessage =>
            $@"YAmount must be > 0 when DurationSec >= {this.minDurationSec}";
        ...
        public bool Validate(cdr obj)
        {
            ...
            return obj.DurationSec >= this.minDurationSec ? obj.YAmount > 0M : obj.YAmount == 0M;
        }
    }
}
