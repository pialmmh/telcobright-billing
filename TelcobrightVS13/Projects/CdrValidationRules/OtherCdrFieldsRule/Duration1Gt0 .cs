...
namespace CdrValidationRules
{
    ...
    public class Duration1Gt0 : IValidationRule<cdr>
    {
        public override string ToString() => this.RuleName;
        public string RuleName => GetType().Name;
        public string ValidationMessage => $@"duration1 must be > 0 when DurationSec >= {this.minDurationSec}";
        ...
        public bool Validate(cdr obj)
        {
            ...
            var retVal = obj.DurationSec >= this.minDurationSec ? obj.Duration1 > 0 : obj.Duration1 == 0;
            return retVal;
        }
    }
}
