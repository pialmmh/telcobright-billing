...
namespace CdrValidationRules
{
    ...
    public class BtrcRevShareTax1Gt0ExceptPrefix : IValidationRule<cdr>
    {
        ...
        public string ValidationMessage =>
            $@"BTRC RevShare(Tax1) must be > 0 when DurationSec >= {this.minDurationSec}";
        ...
        public bool Validate(cdr obj)
        {
            ...
            return obj.DurationSec >= this.minDurationSec ? obj.Tax1 > 0 : obj.Tax1 == 0;
        }
    }
}
