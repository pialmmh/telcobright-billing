...
namespace CdrValidationRules
{
    ...
    public class RevIcxOutNot0 : IValidationRule<cdr>
    {
        public override string ToString() => this.RuleName;
        public string RuleName => GetType().Name;
        public string ValidationMessage =>
            $@"RevenueIcxOut must be > 0 when DurationSec >= {this.minDurationSec}";
        ...
        public bool Validate(cdr obj)
        {
            ...
            return obj.DurationSec >= this.minDurationSec ? obj.RevenueIcxOut != 0M : obj.RevenueIcxOut == 0M;
        }
    }
}
