...
{
    public class CrudGeneratorRoo
    {
        private string NameSpaceName { get; }
        private List<ClassDeclarationRoo> Classes { get; }
        ...
        public CrudGeneratorRoo(string nameSpacename, bool partial, List<string> tables, List<string> namespacesToInclude,
            ...
            List<string> classesToGenerateFluentValidatioinRules)
        {
            ...
            Classes = new List<ClassDeclarationRoo>();
            ...
            foreach (KeyValuePair<string, List<ischema_columns>> kv in TableWiseAttributes)
            {
                ...
                Classes.Add(new ClassDeclarationRoo(kv.Key, kv.Value.Select(c => c.ColumnName).ToList(), this.partial,generatePropertiesAsOverride,generateMethodsAsOverride));
            }
        }
        ...
        void AdjustClassNamesToMatchCodeFirstSingularization(string crudDir, List<ClassDeclarationRoo> classes)
        {
        ...
        {
            foreach (ClassDeclarationRoo c in this.Classes)
            {
