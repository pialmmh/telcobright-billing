        ...
        public JobCompletionStatus Execute(ITelcobrightJobInput jobInputData)
        {
                ...
                if (dstLocation.FileLocation.LocationType == "ftp" || dstLocation.FileLocation.LocationType == "sftp")
                {
                    ...
                    if (srcLocation.FileLocation.Name == dstLocation.FileLocation.Name)
                    {
                        ...
                        else//compression
                        {
                            ...
                            session = dstLocation.GetRemoteFileTransferSession(input.Tbc);
                            ...
                            if (fs.CopyFileLocalRemote(syncPair.DstSettings, session,
                                compressedInfo,destinationSyncInfo,true, false) == false)
                            {
                ...
                srcLocation.FileLocation.LocationType.StartsWith("vault"))
            {
                ...
                else
                {
                    ...
                    {
                        Session session = dstLocation.GetRemoteFileTransferSession(input.Tbc);
