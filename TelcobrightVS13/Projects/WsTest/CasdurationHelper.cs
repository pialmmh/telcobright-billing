...
namespace WsTest
{
    class CasDurationHelper
    {
        ...
        public decimal getDomesticDur(decimal actualDurationSec)
        {
        ...
        public decimal getIntlOutDur(decimal actualDurationSec)
        {
        ...
        public decimal getIntlInDur(decimal actualDuration)
        {

            decimal finalDuration = getDomesticDur(actualDuration);
            return finalDuration;
        }
    }
}
