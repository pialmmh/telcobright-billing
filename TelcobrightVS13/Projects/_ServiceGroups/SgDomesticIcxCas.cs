...
namespace TelcobrightMediation
{
    ...
    public class SgDomesticIcxCas : IServiceGroup
    {
        private readonly SgIntlTransitVoice _sgIntlTransitVoice = new SgIntlTransitVoice();
        public string ToString() => this.RuleName;
        public string RuleName => "Domestic Calls [ICX] Cas";
        public string HelpText => "Service group Domestic for BD ICX Cas";
        public int Id => 201;
        private Dictionary<CdrSummaryType, Type> SummaryTargetTables { get; }

        public SgDomesticIcxCas() //constructor
        {
