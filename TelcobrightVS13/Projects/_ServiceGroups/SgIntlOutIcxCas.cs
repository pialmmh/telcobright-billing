...
namespace TelcobrightMediation
{
    ...
    public class SgIntlOutIcxCas : IServiceGroup
    {
        private readonly SgIntlTransitVoice sgIntlTransitVoice = new SgIntlTransitVoice();
        public override string ToString() => this.RuleName;
        public string RuleName => "International Outgoing Calls [ICX] Cas";
        public string HelpText => "Service group International Outgoing for BD ICX Cas.";
        public int Id => 203;
        private Dictionary<CdrSummaryType, Type> SummaryTargetTables { get; }
        private List<ICdrRule> CdrRules { get; set; } = new List<ICdrRule>();
        public SgIntlOutIcxCas() //constructor
        {
