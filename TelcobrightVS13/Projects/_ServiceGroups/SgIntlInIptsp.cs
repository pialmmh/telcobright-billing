...
namespace TelcobrightMediation
{
    ...
    public class SgIntlInIptsp : IServiceGroup
    {
        private readonly SgIntlTransitVoice _sgIntlTransitVoice = new SgIntlTransitVoice();
        public override string ToString() => this.RuleName;
        public string RuleName => "International Incoming Calls [Iptsp]";

        public string HelpText =>
            "Service group International Incoming for BD Iptsp. Old common mediation codes for Iptsp, could not separate in short time, covers both intl in/out";
        ...
        public SgIntlInIptsp() //constructor
        {
        ...
        public void Execute(cdr thisCdr, CdrProcessor cdrProcessor)
        {
            ...
            if (thisRoute != null)
            {
                ...
                {
                    thisCdr.ServiceGroup = this.Id; //internationa inco in IGW
