...
namespace TelcobrightMediation
{
    ...
    public class SgDomOffNetOut : IServiceGroup
    {
        private readonly SgIntlTransitVoice _sgIntlTransitVoice = new SgIntlTransitVoice();
        public override string ToString() => this.RuleName;
        public string RuleName => "Domestic OffNetOUT Calls [Iptsp]";
        public string HelpText => "Service group Domestic for BD Iptsp.";
        public int Id => 11;
        private Dictionary<CdrSummaryType, Type> SummaryTargetTables { get; }

        public SgDomOffNetOut() //constructor
        {
        ...
        public void Execute(cdr thisCdr, CdrProcessor cdrProcessor)
        {
            ...
            if (incomingRoute != null)
            {
                ...
                {
                    thisCdr.ServiceGroup = this.Id; //Domestic offnet out 
                    return;
                }
            }
        }
