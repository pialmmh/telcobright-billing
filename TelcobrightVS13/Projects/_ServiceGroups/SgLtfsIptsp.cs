                ...
                if (!useCasStyleProcessing)
                {
                    ...
                    ) //ANS and route=national
                    {
                        foreach (string prefix in this.PrefixesOrderedByMaxLenFirst)
                        {
                            ...
                            {
                                cdr.ServiceGroup = this.Id; //LTFS in iptsp           
                                break;
                            }
                        }
                    }
