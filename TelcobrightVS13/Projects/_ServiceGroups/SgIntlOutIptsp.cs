...
namespace TelcobrightMediation
{
    ...
    public class SgIntlOutIptsp : IServiceGroup
    {
        private readonly SgIntlTransitVoice sgIntlTransitVoice = new SgIntlTransitVoice();
        public override string ToString() => this.RuleName;
        public string RuleName => "International Outgoing Calls [Iptsp]";

        public string HelpText =>
            "Service group International Outgoing for BD Iptsp. Old common mediation codes for Iptsp, could not separate in short time, covers both intl in/out";

        public int Id => 15;
        private Dictionary<CdrSummaryType, Type> SummaryTargetTables { get; }

        public SgIntlOutIptsp() //constructor
        {
        ...
        public void Execute(cdr thisCdr, CdrProcessor cdrProcessor)
        {
            ...
            if (thisRoute != null)
            {
                ...
                {
                    thisCdr.ServiceGroup = this.Id; //international Out in IGW
