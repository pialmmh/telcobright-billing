...
{
    public class SegmentedInvoiceProcessor : AbstractRowBasedSegmentedJobProcessor
    {
        ...
        public SegmentedInvoiceProcessor(CdrCollectorInputData cdrCollectorInput,
        ...
        public override ISegmentedJob CreateJobSegmentInstance(jobsegment jobSegment)
        {
            ...
            DbRowCollector<cdr> dbRowCollector =
                new DbRowCollector<cdr>(this.CdrCollectorInput.CdrJobInputData,
