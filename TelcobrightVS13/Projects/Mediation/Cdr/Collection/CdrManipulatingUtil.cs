    ...
    public static class CdrManipulatingUtil
    {
            ...
            out cdrinconsistent cdrInconsistent)
        {
            ...
            try
            {
                ...
                convertedCdr.Tax1 = System.Convert.ToDecimal(txtRow[Fn.Costvatcommissionin].GetValueOrNull<double>());
                ...
                convertedCdr.Tax2 = System.Convert.ToDecimal(txtRow[Fn.Revenuevatcommissionout].GetValueOrNull<double>());
                ...
                convertedCdr.CallCancelDuration = txtRow[Fn.Callcancelduration].GetValueOrNull<decimal>();
        ...
        public static cdrinconsistent ConvertTxtRowToCdrinconsistent(string[] txtRow)
        {
            ...
            inconsistentCdr.CustomerPrePaid = txtRow[Fn.PrePaid];
            ...
            inconsistentCdr.MinuteID = txtRow[Fn.AreaCodeOrLata];
            ...
            inconsistentCdr.MonthId = txtRow[Fn.AdditionalPartyNumber];
            inconsistentCdr.DayId = txtRow[Fn.ResellerIds];
            inconsistentCdr.BTRCTermRate = txtRow[Fn.Btrctermrate];
            inconsistentCdr.WeekDayId = txtRow[Fn.PreviousRoutes];
            ...
            inconsistentCdr.BillngInfo = txtRow[Fn.AdditionalMetaData];
        ...
        public static cdrerror ConvertCdrToCdrError(ICdr sourceCdr)
        {
            ...
            return new cdrerror()//star with cdr error, then cast if necessary
            {
                ...
                CustomerPrePaid = sourceCdr.PrePaid.ToString(),
                ...
                MinuteID = sourceCdr.AreaCodeOrLata.ToString(),
                ...
                CostVATCommissionIn = sourceCdr.Tax1.ToString(),
                ...
                RevenueVATCommissionOut = sourceCdr.Tax2.ToString(),
                ...
                GrpDayId = sourceCdr.AdditionalSystemCodes.ToString(),
                MonthId = sourceCdr.AdditionalPartyNumber.ToString(),
                DayId = sourceCdr.ResellerIds.ToString(),
                BTRCTermRate = sourceCdr.BTRCTermRate.ToString(),
                WeekDayId = sourceCdr.PreviousRoutes.ToString(),
                ...
                BillngInfo = sourceCdr.AdditionalMetaData.ToString(),
