...
namespace TelcobrightMediation.Mediation.Cdr
{
    public static class CdrManipulatingUtil
    {
        ...
        public static ICdr Clone(ICdr sourceCdr)
        {
            ...
            newInstance.FileName = new StringBuilder(sourceCdr.FileName).ToString();
            newInstance.CallDirection = sourceCdr.CallDirection;
            newInstance.incomingroute = new StringBuilder(sourceCdr.incomingroute).ToString();
            newInstance.OriginatingIP = new StringBuilder(sourceCdr.OriginatingIP).ToString();
            newInstance.OPC = sourceCdr.OPC;
            newInstance.OriginatingCIC = sourceCdr.OriginatingCIC;
            newInstance.OriginatingCalledNumber = new StringBuilder(sourceCdr.OriginatingCalledNumber).ToString();
            newInstance.TerminatingCalledNumber = new StringBuilder(sourceCdr.TerminatingCalledNumber).ToString();
            newInstance.OriginatingCallingNumber = new StringBuilder(sourceCdr.OriginatingCallingNumber).ToString();
            newInstance.TerminatingCallingNumber = new StringBuilder(sourceCdr.TerminatingCallingNumber).ToString();
            ...
            newInstance.CountryCode = new StringBuilder(sourceCdr.CountryCode).ToString();
            ...
            newInstance.outgoingroute = new StringBuilder(sourceCdr.outgoingroute).ToString();
            newInstance.TerminatingIP = new StringBuilder(sourceCdr.TerminatingIP).ToString();
            ...
            newInstance.MatchedPrefixY = new StringBuilder(sourceCdr.MatchedPrefixY).ToString();
            newInstance.USDRateY = sourceCdr.USDRateY;
            newInstance.matchedprefixcustomer = new StringBuilder(sourceCdr.matchedprefixcustomer).ToString();
            newInstance.matchedprefixsupplier = new StringBuilder(sourceCdr.matchedprefixsupplier).ToString();
            ...
            newInstance.ANSPrefixOrig = new StringBuilder(sourceCdr.ANSPrefixOrig).ToString();
            newInstance.AnsIdOrig = sourceCdr.AnsIdOrig;
            newInstance.AnsPrefixTerm = new StringBuilder(sourceCdr.AnsPrefixTerm).ToString();
            ...
            newInstance.MediaIP1 = new StringBuilder(sourceCdr.MediaIP1).ToString();
            newInstance.MediaIP2 = new StringBuilder(sourceCdr.MediaIP2).ToString();
            newInstance.MediaIP3 = new StringBuilder(sourceCdr.MediaIP3).ToString();
            newInstance.MediaIP4 = new StringBuilder(sourceCdr.MediaIP4).ToString();
            ...
            newInstance.RedirectingNumber = new StringBuilder(sourceCdr.RedirectingNumber).ToString();
            ...
            newInstance.errorCode = new StringBuilder(sourceCdr.errorCode).ToString();
            ...
            newInstance.UniqueBillId = new StringBuilder(sourceCdr.UniqueBillId).ToString();
            newInstance.BillngInfo = new StringBuilder(sourceCdr.BillngInfo).ToString();
