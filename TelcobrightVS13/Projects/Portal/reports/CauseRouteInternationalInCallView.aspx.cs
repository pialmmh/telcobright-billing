...
public partial class DefaultCauseRouteIntlInCallView2 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        */
        ...
        tempgridval.Add(Session["CauseRouteInternationalInCallView.aspx.csgridcountry"]);//=row.Cells[1].Text;
        tempgridval.Add(Session["CauseRouteInternationalInCallView.aspx.csgriddestination"]);// = row.Cells[2].Text;
        ...
        */
        ...
        //lbl1.Text = sqlstring;
        this.lbl1.Text = "Call View#  "+((this._country == "") ? "" : "Country:" + this._country) + ((this._destination == "") ? "" : " <br /> Destination:" + this._destination) + ((this._ans == "") ? "" : " ANS:" + this._ans) + ((this._icx == "") ? "" : " ICX:" + this._icx) + ((this._partner == "") ? "" : "  Route:" + this._partner);
    ...
    {
        string strquery="Select idPartner,PartnerName from partner where partnertype=1";//only ANS, doesn't have route
    ...
    private void NametoIdMapping()
    {
        ...
        for (int i = 0; i < numOfRows; i++)
        {
            ...
            //else if (dtpartner.Rows[i][1].ToString() == icx)
            //{
            //    icxid = dtpartner.Rows[i][0].ToString();
            //}
            //else if (dtpartner.Rows[i][1].ToString() == partner)
            //{
            //    partnerid = dtpartner.Rows[i][0].ToString();
            //}
        }
    ...
    public static void ExportToSpreadsheet(DataTable table, string name)
    {
        ...
        CreateExcelFileAspNet.CreateExcelDocumentAsStreamEpPlusPackageLastRowSummary(table, "CauseCodeWiseCallsIntlInRoute_" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss")
