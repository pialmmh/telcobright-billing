<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="True"
    CodeBehind="MonthlyRoamingReport.aspx.cs" Inherits="DefultMonthlyRomingReport" %>
    ...
    <script runat="server">
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                {
                    lblScreenTitle.Text = "Reports/BTRC Reports/Monthly Report";
                }
                ...
                <div style="text-align: left;">
                    ...
                    <div style="text-align: left; float: left; clear: left">
                        <asp:GridView ID="Gvdom" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                <asp:BoundField DataField="startTime" HeaderText="Start Time" SortExpression="STime" ItemStyle-Wrap="false" />                                
                                <asp:BoundField DataField="sourceNetwork" HeaderText="Source Network" SortExpression="SNetwork" ItemStyle-Wrap="false" />
                                <asp:BoundField DataField="destinationNetwork" DataFormatString="{0:F0}" HeaderText="Destination Network" SortExpression="Dnetwork" FooterText="" />
                                <asp:BoundField DataField="callerNumberA" DataFormatString="{0:F0}" HeaderText="Caller Number (A NUM)" SortExpression="Anum" FooterText="" />
                                
                                <asp:BoundField DataField="calledNumberB" DataFormatString="{0:F0}" HeaderText="Called Number (B Num)" SortExpression="Bnum" FooterText="" />
                                <asp:BoundField DataField="redirectingNumber" DataFormatString="{0:F0}" HeaderText="Redirect Number" SortExpression="RedirectNumber" FooterText="" />

                                <asp:BoundField DataField="billedDuration" DataFormatString="{0:F0}" HeaderText="Billed Duration" SortExpression="BilledDuration" FooterText="" />
                                <asp:BoundField DataField="remarks" DataFormatString="{0:F0}" HeaderText="Remarks" SortExpression="Remarks" FooterText="" />
                            </Columns>
                            <HeaderStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" />
                            <EditRowStyle BackColor="#999999" />
                            <FooterStyle BackColor="#5D7B9D" Font-Bold="true" ForeColor="White" />
