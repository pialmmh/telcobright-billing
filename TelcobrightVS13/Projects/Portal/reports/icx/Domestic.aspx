...
<div>
 ...
 <div id="ParamBorder" style="float:left;padding-top:3px;padding-left:10px;height:135px;display:block;border:2px ridge #E5E4E2;margin-bottom:5px;width:1300px;">
    <div style="height:20px;background-color:#f2f2f2;color:black;"> 
        ...
        <span style="float:left;font-weight:bold;padding-left:20px;">   Show Revenue <asp:CheckBox ID="CheckBoxShowCost" runat="server" Checked="true" /></span> 
    </div>
    <br />
    <%--date time div--%>
           ...
           <%--<span style="font-size: smaller;position:relative;left:-53px;padding-left:0px;clear:right;">[Enter only Date in "dd/MM/yyyy (e.g. 21/11/2012) or Date+Time in "dd/MM/yyyy HH:mm:ss" (e.g. 21/11/2012 19:01:59) format]</span>   --%>
            ...
            <div style="text-align:left;">
                ...
                <div style="float:left;margin-left:18px;">
                      ...
                      View by Teminating ANS:  <asp:CheckBox ID="CheckBoxShowByIgw" runat="server" 
    ...
    <div style="text-align:center;">
        ...
        <Columns>
            <asp:BoundField DataField="Date" HeaderText="Date" SortExpression="Date" ItemStyle-Wrap="false" />
             <asp:BoundField DataField="Int Partnerr" HeaderText="International Partner" SortExpression="Int Partner" />
            <asp:BoundField DataField="Incoming ANS" HeaderText="Incoming ANS" SortExpression="Incoming ANS" />
            <asp:BoundField DataField="Outgoing ASN" HeaderText="Outgoing ASN" SortExpression="Outgoing ASN" />
            
            <asp:BoundField DataField="CallsCount" 
                HeaderText="Total Calls" 
                SortExpression="CallsCount" />

            <asp:BoundField DataField="Number Of Calls" 
                HeaderText="Successful Calls" 
                SortExpression="Number Of Calls" />
            
            <asp:BoundField DataField="ConnectedCount" 
            HeaderText="Connected Calls" 
            SortExpression="ConnectedCount" />
            
            <asp:BoundField DataField="Paid Minutes"
                DataFormatString="{0:F2}" 
                HeaderText="Actual Duration" 
                SortExpression="Paid Minutes" />
            <asp:BoundField DataField="RoundedDuration" 
                DataFormatString="{0:F2}"
                HeaderText="Billed Duration" 
                SortExpression="RoundedDuration"  />
            <asp:BoundField DataField="Duration1" Visible="false" 
                DataFormatString="{0:F2}"
                HeaderText="Carrier Duration" 
                SortExpression="Duration1"  />
            <asp:BoundField DataField="costansin" 
                DataFormatString="{0:F2}"
                HeaderText="ANS Revenue (BDT)" 
                SortExpression="costansin" />
            <asp:BoundField DataField="costicxin" Visible="false" 
                DataFormatString="{0:F2}"
                HeaderText="ICX/IOS (USD)" 
                SortExpression="costicxin" />
            <asp:BoundField DataField="costvatcomissionin" Visible="false" 
                DataFormatString="{0:F2}"
                HeaderText="BTRC (USD)" 
            ...
            <asp:BoundField DataField="customercost" Visible="false" 
                DataFormatString="{0:F2}"
                HeaderText="Revenue [USD]" 
                SortExpression="customercost" />
            
            <asp:BoundField DataField="igwrevenuein" Visible="false" 
                DataFormatString="{0:F2}"
                HeaderText="IGW $" 
