...
public partial class BanglalinkForwardingReport : System.Web.UI.Page
{
    ...
    List<customBlCallForwarding> ConvertBtrcDataSetToList(DataSet ds) {
        bool hasRecords = ds.Tables.Cast<DataTable>()
                           .Any(table => table.Rows.Count != 0);
        //List<MonthlyReportRow> records = new List<MonthlyReportRow>();
        List<customBlCallForwarding> finalRecords= new List<customBlCallForwarding>();
        if (hasRecords == true)
        {
            foreach (DataTable table in ds.Tables)
            {
                ...
                {
                    customBlCallForwarding record = new customBlCallForwarding();
                    //record.SLNo = Slno;
                    //Slno += 1;                    
    ...
    protected void submit_Click(object sender, EventArgs e)
    {
        ...
        List<customBlCallForwarding> monthlyRecords = new List<customBlCallForwarding>();
        ...
        using (MySqlConnection connection = new MySqlConnection())
        {
            ...
            if (hasdomesticDs == true)
            {
                ...
                DomHeader.Text = "MonthlyOutgoingSummary";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        List<customBlCallForwarding> monthlyReport= new List<customBlCallForwarding>();
        ...
        using (MySqlConnection connection = new MySqlConnection())
        {
            ...
            ExcelExporterForBtrcReport.ExportToExcelBanglalinkForwardingReport("MonthlyReport From " + txtStartDate.Text + " To " + txtEndDate.Text
