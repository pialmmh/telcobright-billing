<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="True"
    CodeBehind="CauseInternationalIn.aspx.cs" Inherits="DefaultCauseIntlIn" %>
<%--Common--%>
...
<%--Page Load and Other Server Side Asp.net scripts--%>
        <script runat="server">
            ...
            if(lblScreenTitle.Text=="")
                    {
                        lblScreenTitle.Text = "Reports/Intl. Incoming/Cause Codes";
                    }
...
<div style="float:left;text-align:left;width:900px;position:relative;top:0px;">
    ...
    <div style="width:760px;text-align:center;">
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            ...
            OnSelectedIndexChanged="Send" onrowdatabound="GridView1_RowDataBound">
