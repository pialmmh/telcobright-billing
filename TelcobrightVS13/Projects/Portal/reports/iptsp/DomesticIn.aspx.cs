...
public partial class DefaultRptDomIn : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            using (PartnerEntities contex = new PartnerEntities())
            {
                ...
                var ANSList = contex.partners.Where(p => p.PartnerType == 2).ToList();
            ...
            {
                lblScreenTitle.Text = "Reports/Domestic Incoming/Traffic";
            }
