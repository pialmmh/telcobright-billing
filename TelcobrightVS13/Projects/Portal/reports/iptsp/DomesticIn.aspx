<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="True"
    CodeBehind="DomesticIn.aspx.cs" Inherits="DefaultRptDomIn" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
 ...
 <div id="report" style="clear:both;height:25px;background-color:white;padding-left:5px;width:1109px;margin-bottom:2px;">
 ...
 <div id="ParamBorder" style="float:left;padding-top:3px;padding-left:10px;height:150px;display:block;border:2px ridge #E5E4E2;margin-bottom:5px;width:1300px;">
    ...
    <div style="float:left;">
     ...
     <asp:TextBox ID="TextBoxUsdRate" runat="server" Visible="false"></asp:TextBox>
       <div id="PartnerFilter" style="min-width:1295px;margin-top:-4px;/*margin-left:10px;*/float:left;padding-left:5px;background-color:#f2f2f2;">
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
           <div style="text-align:left;float:left;visibility:hidden">
            View By Country:
          ...
          <div style="text-align:left;float:left;margin-left:10px;visibility:hidden">
              View by Destination:
           ...
           <div style="float:left;margin-left:10px;visibility:hidden">
               View by Supplier Prefix:
          <asp:CheckBox ID="CheckBoxShowBySupplierPrefix" runat="server" AutoPostBack="false" Checked="false" />
               </div>
            <%--<br />--%>
  ...
  <div style="/*height:600px;overflow:auto;*/">
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
        ...
        <Columns>
            ...
            <asp:BoundField DataField="International Partner" HeaderText="Partner" SortExpression="International Partner" />
            ...
            <asp:BoundField DataField="partnercost" DataFormatString="{0:#,0.#0}" HeaderText="Partner Cost (USD)" SortExpression="partnercost" />
            <asp:BoundField DataField="suppliercost" DataFormatString="{0:#,0.###0}" HeaderText="Supplier Cost" SortExpression="suppliercost" />
            <asp:BoundField DataField="SupplierPrefix" HeaderText="Supplier Prefix" SortExpression="SupplierPrefix" />
