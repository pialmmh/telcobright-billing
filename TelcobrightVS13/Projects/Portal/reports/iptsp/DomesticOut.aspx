<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="True"
    CodeBehind="DomesticOut.aspx.cs" Inherits="DefaultRptDomOut" %>
    ...
    <script runat="server">
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                {
                    lblScreenTitle.Text = "Reports/Domestic Outgoing/Traffic";
                }
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div id="report" style="clear: both; height: 25px; background-color: white; padding-left: 5px; width: 1149px; margin-bottom: 2px;">
    ...
    <div id="ParamBorder" style="float: left; padding-top: 3px; padding-left: 10px; height: 135px; display: block; border: 2px ridge #E5E4E2; margin-bottom: 5px; width: 1300px;">
        ...
        <div id="PartnerFilter" style="min-width:1285px;margin-top:-4px;margin-left:10px;float:left;padding-left:5px;background-color:#f2f2f2;">
            ...
            <div style="text-align: left;">
                ...
                <div style="float: left; height: 25px; min-width: 1280px;">
