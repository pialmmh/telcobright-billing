...
Theme="" AutoEventWireup="True" CodeBehind="assignmentpackage.aspx.cs" Inherits="config_SupplierPackageAssign" %>
...
<div style="margin-left:-10px;margin-top:-20px;">
    ...
    <div style="float:left;width:200px;padding-top:5px;padding-left:10px;">
        <asp:LinkButton ID="LinkButton1" runat="server" Text="Add New Rate" 
                        onclick="LinkButton1_Click">New Package Assignment</asp:LinkButton>
    </div>
</div>
