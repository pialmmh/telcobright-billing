...
public partial class ConfigSupplierPackage : Page
{
    ...
    protected void GridViewSupplierRatePlan_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                lnkBtn.OnClientClick = "window.open('packagetask.aspx?idRatePlan=" + DataBinder.Eval(e.Row.DataItem, "id").ToString() + "'); return false;";

                lnkBtn = (LinkButton)e.Row.FindControl("LinkButtonRate");
                lnkBtn.OnClientClick = "window.open('package.aspx?idRatePlan=" + DataBinder.Eval(e.Row.DataItem, "id").ToString() + "'); return false;";
    ...
    protected void cvAll_Validate(object source, ServerValidateEventArgs args)
    {
        ...
        ddlistPlanType.SelectedIndex = 1;
    ...
    protected void frmSupplierRatePlanInsert_ItemInserting(object sender, FormViewInsertEventArgs e)
    {
        ...
        newPlan.field2 = 1;//package indicator
        using (PartnerEntities context = new PartnerEntities())
        {
