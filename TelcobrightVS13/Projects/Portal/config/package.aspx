<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="True" CodeBehind="package.aspx.cs" Inherits="ConfigSupplierPackage" %>
...
(select sf.id, concat(servicename,' [',sc.type,']') as servicename from enumservicefamily sf
 ...
 on sf.servicecategory=sc.id)                 
    " ></asp:SqlDataSource>
            ...
            <asp:DropDownList ID="ddlistSupplierRatePlanType" runat="server" Visible="False" 
...
Package Name Having: <asp:TextBox ID="TextBoxRatePlanName" runat="server"></asp:TextBox>
...
<asp:LinkButton ID="LinkButton1" runat="server" Text="Add New Rate Plan" 
        onclick="LinkButton1_Click" Font-Size="Smaller">Add New Package</asp:LinkButton>
    ...
    <asp:FormView ID="frmSupplierRatePlanInsert" runat="server" DataKeyNames="id" 
       ...
       <EditRowStyle BackColor="#f2f2f2" />
        ...
        <InsertItemTemplate>
          ...
          <table border="0"  width="1000px">
            ...
            <td style="min-width:500px">
                ...
                <%--<b> Service Family:</b>--%>
                 <asp:DropDownList ID="DropDownListType" runat="server" Visible="False" SelectedValue='<%# Bind("Type") %>'
            ...
            <div style="padding-left:115px;display:none">
                        <%--<b> Time Zone:</b>--%>
                        <asp:DropDownList ID="ddlistTimeZone" runat="server" AutoPostBack="false" DataSourceID="SqlDataTimeZone" Visible="False" 
        ...
        <div style="margin-left:-70px;width:900px;overflow:visible;margin-top:10px;background-color:#F7F6F3;height:100px;padding:5px;">
            ...
            <%--<b>Currency:</b>--%>
                <asp:DropDownList ID="DropDownListCurrency" runat="server"  Visible="False"
                        Enabled="true" >
                ...
                <%--<b>Billing Span</b> --%>
                      <asp:DropDownList ID="DropDownListBillingSpan" runat="server" AutoPostBack="false" Visible="False"
                ...
                <%--<b>Category</b> --%>
                      <asp:DropDownList ID="DropDownListServiceType" runat="server" AutoPostBack="false" Visible="False"
                      ...
                      <br />
                       <%--<b> Pulse:</b>--%>
               <asp:TextBox ID="txtResolution" Enabled="True" runat="server" Text="1" Visible="False"></asp:TextBox>
               <br />
                ...
                <div style="float:left;min-width:400px;text-align:right;margin-left:50px;">
                    ...
                    <span style="margin-right:105px;">
                        ...
                        <asp:TextBox ID="txtSurchargeTime" visible="False" runat="server" Text="0"></asp:TextBox>
                    </span>
                    <br />
                    <span style="margin-right:105px;">
                    <%--<b> Charge for Fixed Initial Period:</b> --%>
                    <asp:TextBox ID="txtSurchargeAmount" visible="False" runat="server" Text="0.0"></asp:TextBox>
                    </span>
                        <br />
                    <span style="margin-right:105px;">
                    <%--<b> Minimum Duration (Sec):</b>--%>
               <asp:TextBox ID="txtMinDurationSec" Enabled="True" Visible="False" runat="server" Text="0"></asp:TextBox>
               </span>
                        <br />
                    
                    <%--<b> Round Digits after Decimal for Rate Amount:</b>--%>
                        <asp:TextBox ID="TextBoxRoundUp" Enabled="True" Visible="False" runat="server" Text="0"></asp:TextBox>
                    
                    <%--<asp:Label ID="Label1" runat="server" Text="[0=No Rounding]"></asp:Label>--%>
                    <br />
                     <span style="margin-right:106px;">
                        <%--<b> Ambiguous Date Handling:</b> --%>
                        <asp:DropDownList ID="DropDownListAmbiguous" AppendDataBoundItems="true" runat="server" Visible="False" Width="173px">
                    ...
                    <span style="margin-right:110px;">
                        ...
                        <asp:DropDownList ID="DropDownListLcrRef" AppendDataBoundItems="true" Visible="False" runat="server" Width="173px">
...
order by Type "
   ...
   <div style="width:1800px;overflow-x:scroll;">
        ...
        <Columns>
            ...
            <asp:TemplateField>
             ...
             <asp:TemplateField>
                <ItemTemplate>
                    ...
                    <asp:LinkButton ID="LinkButtonRate" runat="server">Item</asp:LinkButton>
            ...
            <asp:BoundField DataField="RatePlanName" HeaderText="Package Name" ItemStyle-Wrap="false"
                SortExpression="RatePlanName" />
            

             <asp:TemplateField HeaderText="Service Family" SortExpression="Type" Visible="False">
            ...
            <asp:TemplateField HeaderText="TimeZone" SortExpression="TimeZone" ItemStyle-Wrap="false"  Visible="False">
            ...
            <asp:BoundField DataField="field4" HeaderText="Tech Prefix" SortExpression="field4" visible="False" />
            <asp:BoundField DataField="Description" HeaderText="Description" ItemStyle-Wrap="false" 
                SortExpression="Description" visible="true" />
            

           
            <asp:TemplateField HeaderText="Default Pulse" SortExpression="Resolution" ControlStyle-Width="30px"  Visible="False" >
                <ItemTemplate>
...
<ControlStyle Width="30px"></ControlStyle>
              ...
              <asp:TemplateField HeaderText="Default Round Digits after Decimal for Rate Amount" SortExpression="RateAmountRoundupDecimal" ControlStyle-Width="120" Visible="False" >
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="Min Duration (Sec)" SortExpression="mindurationsec" ControlStyle-Width="30px"  Visible="False" >
                <ItemTemplate>
...
<ControlStyle Width="30px"></ControlStyle>
            ...
            <asp:TemplateField HeaderText="Reference Rateplan for LCR" SortExpression="field3"  Visible="False" >
                <ItemTemplate>
             ...
             <asp:TemplateField HeaderText="Ambiguous Date Handling by" SortExpression="field5" ControlStyle-Width="175px"  Visible="False" >
                <ItemTemplate>
                    <%--if DF then Day first, else MF, Months First is the default--%>
           ...
           <asp:TemplateField HeaderText="Default Fixed Charge Duration (Sec)" SortExpression="SurchargeTime" ControlStyle-Width="120px"  Visible="False" >
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="Default Fixed Charge Amount" SortExpression="SurchargeAmount" ControlStyle-Width="120px"  Visible="False" >
                <ItemTemplate>
             ...
             <asp:TemplateField HeaderText="Default Billing Span" SortExpression="billingspan"  Visible="False">
  ...
  <asp:TemplateField HeaderText="Default Category" SortExpression="Category"  Visible="False">
             ...
             <asp:TemplateField HeaderText="Default Sub Category" SortExpression="SubCategory" ControlStyle-Width="100px"  Visible="False">
