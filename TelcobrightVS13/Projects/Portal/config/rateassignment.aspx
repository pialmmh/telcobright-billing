...
Theme="" AutoEventWireup="True" CodeBehind="rateassignment.aspx.cs" Inherits="config_SupplierRatePlanDetailRateAssign" %>
...
<div style="margin-left:-10px;margin-top:-20px;">
    ...
    <div style="float:left;width:200px;padding-top:5px;padding-left:10px;">
        <asp:LinkButton ID="LinkButton1" runat="server" Text="Add New Rate" 
                        onclick="LinkButton1_Click">New Rate Plan Assignment</asp:LinkButton>
    </div>
</div>
                ...
                <table border="0" width="980px">
                    <tr>
                        ...
                        <td > <%--width="200px"--%>
                            ...
                            <div style="float:left;text-align:right; min-width:200px;margin-top:0px;">
                                ...
                                <asp:DropDownList ID="DropDownListPartnerType" runat="server" AutoPostBack="True" 
                                                  ...
                                                  Enabled="True" OnSelectedIndexChanged="PartnerTypeSelectedIndexChanged" >
                                </asp:DropDownList>
                                <br />
                                ...
                                <asp:DropDownList ID="DropDownListAssignedDirection" runat="server" AutoPostBack="true" 
                                                  ...
                                                  Enabled="true" OnSelectedIndexChanged="FormviewPartnerDirectionSelectedIndexChanged">
                        ...
                        <td > <%--width="200px"--%>
                            ...
                            <div style="float:left;text-align:right;margin-top:0px;margin-right:100px;">
...
<div style="margin-top:4px;padding-left:10px;">
    ...
    <div style="height:24px;border-style:ridge;min-width:1040px;margin-left:-10px;padding-top:2.5px;background-color:#f2f2f2;color:Black;">
        ...
        Service:
        <asp:DropDownList ID="ddlTypeFind" runat="server" AutoPostBack="false" 
                          DataSourceID="SqlDataservice" DataTextField="type" DataValueField="id" 
                          Enabled="True" >
        </asp:DropDownList>
        
        Assigned Direction:
        <asp:DropDownList ID="ddlAssignedDirectionFind" runat="server" AutoPostBack="false" 
                          DataTextField="name" DataValueField="id" 
                          Enabled="true" >
...
<asp:Label ID="lblAssignedPlans" runat="server" Text="Assigned Rateplans" Font-Bold="true"></asp:Label>
...
<asp:TemplateField>
    ...
    <ItemTemplate>
        ...
        <asp:LinkButton ID="LinkButtonRate" ButtonType="Button" runat="server">Rates</asp:LinkButton>
    </ItemTemplate>
    <EditItemTemplate>
        <asp:LinkButton ID="LinkButtonEdit" ButtonType="Button" CommandName="Update"  runat="server" CausesValidation="false" ValidationGroup="allcontrols">Update</asp:LinkButton>
...
<asp:TemplateField HeaderText="Route" SortExpression="RouteDisabled">
...
<asp:TemplateField HeaderText="Exclude from LCR" SortExpression="field3" >
