<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="True"
    CodeBehind="InternationalOut.aspx.cs" Inherits="_DefaultRptIntlOut" %>
...
<div>
 ...
 <div id="ParamBorder" style="float:left;padding-top:3px;padding-left:10px;height:150px;display:block;border:2px ridge #E5E4E2;margin-bottom:5px;width:1300px;">
    <div style="height:20px;background-color:#EBF0FF;color:black;"> 
    ...
    <br />
    <%--date time div--%>
     <div id="DateTimeDiv" style="padding-left:5px;position:relative;float:left;left:10px;top:-11px;width:630px;z-index:10;background-color:#FFFAF0;height:70px;"> <%--Start OF date time/months field DIV--%>
    ...
    <div style="float:left;">
     ...
     <asp:TextBox ID="TextBoxUsdRate" runat="server" Visible="false"></asp:TextBox>
       <div id="PartnerFilter" style="min-width:1300px;margin-top:-4px;margin-left:10px;float:left;padding-left:5px;background-color:#EBF0FF;">
  ...
  <div style="/*height:600px;overflow:auto;*/">
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
        ...
        <Columns>
            ...
            <asp:BoundField DataField="ConnectByCC" 
            ...
            <asp:BoundField DataField="profitbdt" DataFormatString="{0:#,0.#0}" HeaderText="Profit (BDT)" SortExpression="profitbdt" />
            <asp:BoundField DataField="profitminute" DataFormatString="{0:#,0.#0}" HeaderText="Profit (BDT) /Minute" SortExpression="profitminute" />
