<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="True" CodeBehind="AccountDetails.aspx.cs" Inherits="AccountDetails" %>
                ...
                <HeaderTemplate>
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            ...
                            <td width="320px" align="center">Automation</td>
                ...
                <ItemTemplate>
                    <asp:Panel ID="pnlAccount" runat="server" >
                        <asp:GridView ID="gvAccount" runat="server" AutoGenerateColumns="false" ForeColor="#333333" GridLines="Vertical" Font-Size="9pt" 
                            ShowHeader="False" BorderStyle="Solid" BorderColor="Silver" OnRowDataBound="gvAccount_OnRowDataBound" DataKeyNames="id">
                            <Columns>
                                ...
                                <asp:TemplateField ItemStyle-Width="320px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left">
                                    <ItemTemplate>
                                        <asp:Label runat="server" ID="lblAutomation"/>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField ItemStyle-Width="80px">
                                    <ItemTemplate>
                                        <asp:LinkButton runat="server" ID="lbEditAction" Text="Edit Action" OnClick="lbEditAction_OnClick" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
