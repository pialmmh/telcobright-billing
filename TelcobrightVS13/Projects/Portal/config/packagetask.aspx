<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="True" CodeBehind="packagetask.aspx.cs" Inherits="ConfigPackageTask" EnableViewState="true" %>
...
select (select 1) as id,(select 'Yes') as Type "
    ...
    Package plan: <span style="padding-left:10px;padding-right:5px;"> <asp:Label ID="lblRatePlan" runat="server" Font-Bold="true" Text=""></asp:Label> 
        </span>
    <asp:LinkButton ID="LinkButtonRate" runat="server">Packages</asp:LinkButton>
    ...
    <div style="color:Black;">Create or Import New Package
        ...
        <span style="padding-left:5px; visibility: hidden"> <asp:CheckBox ID="CheckBoxAutoConvertTZ" runat="server" Text="Auto Adjust effective Date/Time for New/Import Task" Checked="true" ></asp:CheckBox></span>
    </div> 
    <div style="min-width:1500px;min-height:60px;border-style:ridge;float:left;padding-top:2.5px;background-color:#F7F6F3;color:Black;">
        ...
        <div style="float:left; height:22px;width:750px;margin-left:2px;padding-top:10px;float:left;background-color:#F7F6F3;color:Black;">
                ...
                onclick="LinkButton1_Click">New Package</asp:LinkButton>
                    </span>
            Or, <span style="padding-left:3px;">
                <asp:LinkButton ID="LinkButtonCodeDelete" runat="server" Text="Code Delete Package with Helper" 
...
<asp:ValidationSummary ID="ValidatorSummary" runat="server"
    ...
    <div style="padding-left:12px;background-color:#F7F6F3;">
        ...
        <InsertItemTemplate>
          ...
          <b>Create a New Package Task</b> &nbsp [Enter Rateamount=-1 for Code Delete Task]
          <table border="0" width="2200px">
            ...
            <td style="width:350px;" > <%--width="200px"--%>
               ...
               <div style="text-align:right; width:350px;margin-top:0px;">
                   ...
                   <asp:TextBox ID="TextBox1" visible="True" runat="server" Text=""></asp:TextBox>
                   <br />
                  
             <%--  Country:--%>
               <asp:DropDownList ID="DropDownListCountry" runat="server" AutoPostBack="false" Visible="False" 
               ...
               <br />
                   ...
                   <b> Description:</b>
                        <asp:TextBox ID="txtDescription" Enabled="True" runat="server" Visible="true" Text=""></asp:TextBox>
                        <br />
                   <%-- <b> Rate Amount:</b>--%>
                        <asp:TextBox ID="txtRateAmount" Enabled="True" runat="server" Visible="False" Text=""></asp:TextBox>
                    <br />
                    <%--<b> Pulse:</b>--%>
               <asp:TextBox ID="txtResolution" Enabled="True" runat="server" Visible="False" Text="1"></asp:TextBox>
               <br />
               <%--<b> Minimum Duration: (Sec)</b>--%>
               <asp:TextBox ID="txtMinDurationSec" Enabled="True" runat="server" Visible="False" Text="0"></asp:TextBox>
               <br />
            ...
            <td style="width:200px; visibility: hidden" > 
            ...
            <td style="width:280px; visibility: hidden">
                    <div style="text-align:right">
                        <asp:Label ID="lblOtherAmount1" runat="server" Text="Volume"  Font-Bold="true"></asp:Label>
                        <asp:TextBox ID="txtOtherAmount1" visible="True" runat="server" Text=""></asp:TextBox>
                        <br />
                    
                       <%-- <asp:Label ID="lblOtherAmount2" runat="server" Text="Other Amount 2"  Font-Bold="true" Visible="False"></asp:Label>
                        <asp:TextBox ID="txtOtherAmount2" visible="True" runat="server" Text=""></asp:TextBox>
                        <br />

                        <asp:Label ID="lblOtherAmount3" runat="server" Text="Other Amount 3"  Font-Bold="true" Visible="False"></asp:Label>
                        <asp:TextBox ID="txtOtherAmount3" visible="True" runat="server" Text=""></asp:TextBox>
                        <br />

                        <asp:Label ID="lblOtherAmount4" runat="server" Text="Other Amount 4" Font-Bold="true" Visible="False"></asp:Label>
            ...
            <td style="text-align:left;padding-left:15px; visibility: hidden">

                    <asp:Label ID="lblOtherAmount5" runat="server" Text="Other Amount 5" Font-Bold="true" Visible="False"></asp:Label>
                    <asp:TextBox ID="txtOtherAmount5" visible="True" runat="server" Text=""></asp:TextBox>
                    <br />

                    <asp:Label ID="lblOtherAmount6" runat="server" Text="Other Amount 6"  Font-Bold="true" Visible="False"></asp:Label>
                    <asp:TextBox ID="txtOtherAmount6" visible="True" runat="server" Text=""></asp:TextBox>
                    <br />
                    
                    <asp:Label ID="lblOtherAmount7" runat="server" Text="Other Amount 7"  Font-Bold="true" Visible="False"></asp:Label>
                    <asp:TextBox ID="txtOtherAmount7" visible="True" runat="server" Text=""></asp:TextBox>
                    <br />

                    <asp:Label ID="lblOtherAmount8" runat="server" Text="Other Amount 8"  Font-Bold="true" Visible="False"></asp:Label>
          ...
          <tr>
           ...
           <div style="padding-left:100px;visibility: hidden">
            <div style="float:left;text-align:right;visibility: hidden ">
                ...
                <div style="float:left;width:500px;text-align:right; visibility: hidden">
                  ...
                  <asp:TextBox ID="txtSurchargeTime" visible="true" runat="server" Text="0"></asp:TextBox>
                    ...
                    <br /> 
                    <asp:Label ID="label10" runat="server" Text="[0=No Rounding]" Visible="False"></asp:Label>
                </div>
            </div>
...
<ControlStyle Width="20px"></ControlStyle>
             ...
             <asp:TemplateField HeaderText="Type" SortExpression="Status" ItemStyle-Wrap="false" Visible="False">
            ...
            <asp:TemplateField HeaderText="Execution Order" SortExpression="ExecutionOrder" ControlStyle-Width="50px" Visible="False">
...
<ControlStyle Width="50px"></ControlStyle>
        ...
        <asp:TemplateField HeaderText="Category" SortExpression="Category">
            ...
            <asp:TemplateField HeaderText="Rate" SortExpression="rateamount" ItemStyle-Wrap="false" Visible="False" >
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="EndTime" SortExpression="EndTime" Visible="false">
                ...
                <asp:TemplateField HeaderText="Effective Since" SortExpression="startdate" ControlStyle-Width="125px" Visible="False">
...
<ControlStyle Width="115px"></ControlStyle>
             ...
             <asp:TemplateField HeaderText="Valid Before" SortExpression="enddate" ControlStyle-Width="125px" Visible="False">
...
<ControlStyle Width="125px"></ControlStyle>
            ...
            <asp:TemplateField HeaderText="Pulse" SortExpression="Resolution" ControlStyle-Width="30px" Visible="False" >
                <ItemTemplate>
...
<ControlStyle Width="30px"></ControlStyle>
            ...
            <asp:TemplateField HeaderText="Min Duration (Sec)" SortExpression="MinDurationSec" ControlStyle-Width="80" Visible="False" >
                <ItemTemplate>
             ...
             <asp:TemplateField HeaderText="Country" SortExpression="CountryCode" ControlStyle-Width="200px" Visible="False" >
...
<ControlStyle Width="200px"></ControlStyle>
             ...
             <asp:TemplateField HeaderText="Round Digits after Decimal for Rate Amount" SortExpression="" Visible="False" ControlStyle-Width="200">
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="Volume" SortExpression="OtherAmount1" Visible="True" ControlStyle-Width="30px">
                <ItemTemplate>
        ...
        <asp:TemplateField HeaderText="Description" SortExpression="Description" ItemStyle-Wrap="false">
            ...
            <asp:TemplateField HeaderText="Other Amount 2" SortExpression="OtherAmount2" Visible="False" ControlStyle-Width="50px">
                <ItemTemplate>
...
<ControlStyle Width="50px"></ControlStyle>
            ...
            <asp:TemplateField HeaderText="Other Amount 3" SortExpression="OtherAmount3" Visible="False" ControlStyle-Width="50px">
                <ItemTemplate>
...
<ControlStyle Width="50px"></ControlStyle>
            ...
            <asp:TemplateField HeaderText="Other Amount 4" SortExpression="OtherAmount4" Visible="False" ControlStyle-Width="70px">
                <ItemTemplate>
...
<ControlStyle Width="70px"></ControlStyle>
            ...
            <asp:TemplateField HeaderText="Other Amount 5" SortExpression="OtherAmount5" Visible="False" ControlStyle-Width="70px">
                <ItemTemplate>
...
<ControlStyle Width="70px"></ControlStyle>
            ...
            <asp:TemplateField HeaderText="Other Amount 6" SortExpression="OtherAmount6" Visible="False" ControlStyle-Width="50px">
                <ItemTemplate>
...
<ControlStyle Width="50px"></ControlStyle>
            ...
            <asp:TemplateField HeaderText="Other Amount 7" SortExpression="OtherAmount7" Visible="False" ControlStyle-Width="50px">
                <ItemTemplate>
...
<ControlStyle Width="50px"></ControlStyle>
            ...
            <asp:TemplateField HeaderText="Other Amount 8" SortExpression="OtherAmount8" Visible="False" ControlStyle-Width="50px">
                <ItemTemplate>
...
<ControlStyle Width="50px"></ControlStyle>
           ...
           <asp:TemplateField HeaderText="Fixed Charge Duration (Sec)" SortExpression="SurchargeTime" ControlStyle-Width="100px" Visible="False" >
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="Fixed Charge Amount" SortExpression="SurchargeAmount" ControlStyle-Width="30px" Visible="False" >
                <ItemTemplate>
...
<ControlStyle Width="30px"></ControlStyle>
            ...
            <asp:TemplateField HeaderText="Sub Category" SortExpression="SubCategory" ControlStyle-Width="100px" Visible="False">
