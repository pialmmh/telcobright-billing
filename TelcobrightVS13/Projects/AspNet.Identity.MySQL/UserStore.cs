...
namespace AspNet.Identity.MySQL
{
        ...
        where TUser : IdentityUser
    {
        ...
        private UserRolesTable _userRolesTable;
        ...
        public UserStore(MySqlDatabase database)
        {
            ...
            this._userTable = new UserTable<TUser>(database);
            this._roleTable = new RoleTable(database);
            this._userRolesTable = new UserRolesTable(database);
            this._userClaimsTable = new UserClaimsTable(database);
            this._userLoginsTable = new UserLoginsTable(database);
        }
        ...
        public Task<TUser> FindByIdAsync(string userId)
        {
            ...
            TUser result = this._userTable.GetUserById(userId) as TUser;
            if (result != null)
            {
        ...
        public Task<TUser> FindByNameAsync(string userName)
        {
            ...
            List<TUser> result = this._userTable.GetUserByName(userName) as List<TUser>;
        ...
        public Task AddClaimAsync(TUser user, Claim claim)
        {
            ...
            this._userClaimsTable.Insert(claim, user.Id);
        ...
        {
            ClaimsIdentity identity = this._userClaimsTable.FindByUserId(user.Id);
        ...
        public Task RemoveClaimAsync(TUser user, Claim claim)
        {
            ...
            this._userClaimsTable.Delete(user, claim);
        ...
        public Task AddLoginAsync(TUser user, UserLoginInfo login)
        {
            ...
            this._userLoginsTable.Insert(user, login);
        ...
        public Task<TUser> FindAsync(UserLoginInfo login)
        {
            ...
            var userId = this._userLoginsTable.FindUserIdByLogin(login);
            if (userId != null)
            {
                TUser user = this._userTable.GetUserById(userId) as TUser;
                if (user != null)
                {
        ...
        public Task<IList<UserLoginInfo>> GetLoginsAsync(TUser user)
        {
            ...
            List<UserLoginInfo> logins = this._userLoginsTable.FindByUserId(user.Id);
            if (logins != null)
            {
        ...
        public Task RemoveLoginAsync(TUser user, UserLoginInfo login)
        {
            ...
            this._userLoginsTable.Delete(user, login);
        ...
        public Task AddToRoleAsync(TUser user, string roleName)
        {
            ...
            string roleId = this._roleTable.GetRoleId(roleName);
            if (!string.IsNullOrEmpty(roleId))
            {
                this._userRolesTable.Insert(user, roleId);
            }
        ...
        public Task<IList<string>> GetRolesAsync(TUser user)
        {
            ...
            List<string> roles = this._userRolesTable.FindByUserId(user.Id);
            {
                if (roles != null)
                {
        ...
        {
            string passwordHash = this._userTable.GetPasswordHash(user.Id);
        ...
        {
            var hasPassword = !string.IsNullOrEmpty(this._userTable.GetPasswordHash(user.Id));
        ...
        public Task<TUser> FindByEmailAsync(string email)
        {
            ...
            TUser result = this._userTable.GetUserByEmail(email) as TUser;
            if (result != null)
            {
                return Task.FromResult<TUser>(result);
            }
