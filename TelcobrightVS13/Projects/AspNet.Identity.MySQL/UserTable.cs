...
namespace AspNet.Identity.MySQL
{
        ...
        where TUser :IdentityUser
    {
        ...
        public string GetUserName(string userId)
        {
            ...
            return this._database.GetStrValue(commandText, parameters);
        }
        ...
        public TUser GetUserById(string userId)
        {
            ...
            var rows = this._database.Query(commandText, parameters);
        ...
        public string GetPasswordHash(string userId)
        {
            ...
            var passHash = this._database.GetStrValue(commandText, parameters);
        ...
        public string GetSecurityStamp(string userId)
        {
            ...
            Dictionary<string, object> parameters = new Dictionary<string, object>() { { "@id", userId } };
            var result = this._database.GetStrValue(commandText, parameters);
