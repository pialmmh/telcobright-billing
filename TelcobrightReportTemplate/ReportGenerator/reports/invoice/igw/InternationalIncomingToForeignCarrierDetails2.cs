...
{
    public partial class InternationalIncomingToForeignCarrierDetails2 : DevExpress.XtraReports.UI.XtraReport, IInvoiceReport
    {
        public InternationalIncomingToForeignCarrierDetails2(Invoice invoice)
        {
            InitializeComponent();
