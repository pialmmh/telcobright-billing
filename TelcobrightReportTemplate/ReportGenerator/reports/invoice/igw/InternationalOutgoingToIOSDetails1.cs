...
{
    public partial class InternationalOutgoingToIOSDetails1 : DevExpress.XtraReports.UI.XtraReport, IInvoiceReport
    {
        public InternationalOutgoingToIOSDetails1(Invoice invoice)
        {
            InitializeComponent();
            generateReport(invoice);
        }

        public InvoiceReportType reportType { get { return InvoiceReportType.InternationalOutgoingToIOSDetails1; } }
