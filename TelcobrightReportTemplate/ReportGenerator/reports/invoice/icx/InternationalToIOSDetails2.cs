...
{
    public partial class InternationalToIOSDetails2 : DevExpress.XtraReports.UI.XtraReport, IInvoiceReport
    {
        public InternationalToIOSDetails2(Invoice invoice)
        {
            InitializeComponent();
            generateReport(invoice);
        }

        public InvoiceReportType reportType { get { return InvoiceReportType.InternationalToIOSDetails2; } }
