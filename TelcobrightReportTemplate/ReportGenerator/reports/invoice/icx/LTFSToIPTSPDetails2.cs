...
{
    public partial class LTFSToIPTSPDetails2 : DevExpress.XtraReports.UI.XtraReport, IInvoiceReport
    {
        public LTFSToIPTSPDetails2(Invoice invoice)
        {
            InitializeComponent();
            generateReport(invoice);
        }

        public InvoiceReportType reportType { get { return InvoiceReportType.LTFSToIPTSPDetails2; } }
