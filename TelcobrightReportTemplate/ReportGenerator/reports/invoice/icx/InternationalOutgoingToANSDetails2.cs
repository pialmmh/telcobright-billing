...
{
    public partial class InternationalOutgoingToANSDetails2 : DevExpress.XtraReports.UI.XtraReport, IInvoiceReport
    {
        public InternationalOutgoingToANSDetails2(Invoice invoice)
        {
            InitializeComponent();
            generateReport(invoice);
        }

        public InvoiceReportType reportType { get { return InvoiceReportType.InternationalOutgoingToANSDetails2; } }
