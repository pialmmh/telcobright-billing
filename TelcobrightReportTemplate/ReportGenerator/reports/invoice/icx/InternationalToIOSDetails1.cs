...
{
    public partial class InternationalToIOSDetails1 : DevExpress.XtraReports.UI.XtraReport, IInvoiceReport
    {
        public InternationalToIOSDetails1(Invoice invoice)
        {
            InitializeComponent();
            generateReport(invoice);
        }

        public InvoiceReportType reportType { get { return InvoiceReportType.InternationalToIOSDetails1; } }
