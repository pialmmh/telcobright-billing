...
{
    public partial class InternationalOutgoingToANSDetails1 : DevExpress.XtraReports.UI.XtraReport, IInvoiceReport
    {
        public InternationalOutgoingToANSDetails1(Invoice invoice)
        {
            InitializeComponent();
            generateReport(invoice);
        }

        public InvoiceReportType reportType { get { return InvoiceReportType.InternationalOutgoingToANSDetails1; } }
