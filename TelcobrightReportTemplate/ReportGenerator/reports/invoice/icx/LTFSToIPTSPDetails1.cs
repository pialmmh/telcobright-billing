...
{
    public partial class LTFSToIPTSPDetails1 : DevExpress.XtraReports.UI.XtraReport, IInvoiceReport
    {
        public LTFSToIPTSPDetails1(Invoice invoice)
        {
            InitializeComponent();
            generateReport(invoice);
        }

        public InvoiceReportType reportType { get { return InvoiceReportType.LTFSToIPTSPDetails1; } }
